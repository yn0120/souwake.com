            ...
            5529: function(t) {
                t.exports = function() {
                    ...
                    function v(t, e, r, i, n) {
                        ...
                        e && (d.dispatchEvent(b("ps-scroll-" + a)),
                    ...
                    function L(t) {
                        ...
                        t.scrollbarYTop = m(r * (t.railYHeight - t.scrollbarYHeight) / (t.contentHeight - t.containerHeight))) : t.scrollbarYActive = !1,
                        t.scrollbarXLeft >= t.railXWidth - t.scrollbarXWidth && (t.scrollbarXLeft = t.railXWidth - t.scrollbarXWidth),
                        t.scrollbarYTop >= t.railYHeight - t.scrollbarYHeight && (t.scrollbarYTop = t.railYHeight - t.scrollbarYHeight),
                        W(e, t),
                        t.scrollbarXActive ? e.classList.add(s.state.active("x")) : (e.classList.remove(s.state.active("x")),
                        t.scrollbarXWidth = 0,
                        t.scrollbarXLeft = 0,
                        e.scrollLeft = !0 === t.isRtl ? t.contentWidth : 0),
                        t.scrollbarYActive ? e.classList.add(s.state.active("y")) : (e.classList.remove(s.state.active("y")),
                    ...
                    function S(t, e) {
                        ...
                        function y(e) {
                            ...
                            g = e[n],
                            v = (t[i] - t[r]) / (t[l] - t[a]),
                            e.touches ? (document.addEventListener("touchmove", m, {
                                passive: !1
                            }),
                            document.addEventListener("touchend", Y)) : (document.addEventListener("mousemove", m),
                    ...
                    function H(t) {
                        ...
                        t.event.bind(t.ownerDocument, "keydown", (function(n) {
                            if (!(n.isDefaultPrevented && n.isDefaultPrevented() || n.defaultPrevented) && (r() || i())) {
                                ...
                                t.settings.suppressScrollX && 0 !== s || t.settings.suppressScrollY && 0 !== a || (e.scrollTop -= a,
                                e.scrollLeft += s,
                                L(t),
                    ...
                    function M(e) {
                        ...
                        function o(t) {
                            ...
                            if (!l(t.target, s, a)) {
                                var c = !1;
                                e.settings.useBothWheelAxes ? e.scrollbarYActive && !e.scrollbarXActive ? (a ? r.scrollTop -= a * e.settings.wheelSpeed : r.scrollTop += s * e.settings.wheelSpeed,
                                c = !0) : e.scrollbarXActive && !e.scrollbarYActive && (s ? r.scrollLeft += s * e.settings.wheelSpeed : r.scrollLeft -= a * e.settings.wheelSpeed,
                                c = !0) : (r.scrollTop -= a * e.settings.wheelSpeed,
                    ...
                    function x(e) {
                        if (X.supportsTouch || X.supportsIePointer) {
                            ...
                            X.supportsTouch ? (e.event.bind(r, "touchstart", c),
                            e.event.bind(r, "touchmove", u),
                            e.event.bind(r, "touchend", d)) : X.supportsIePointer && (window.PointerEvent ? (e.event.bind(r, "pointerdown", c),
                            e.event.bind(r, "pointermove", u),
                            e.event.bind(r, "pointerup", d)) : window.MSPointerEvent && (e.event.bind(r, "MSPointerDown", c),
                        ...
                        function d() {
                            ...
                            i.easingLoop = setInterval((function() {
                                e.isInitialized ? clearInterval(i.easingLoop) : i.speed.x || i.speed.y ? Math.abs(i.speed.x) < .01 && Math.abs(i.speed.y) < .01 ? clearInterval(i.easingLoop) : (l(30 * i.speed.x, 30 * i.speed.y),
                                i.speed.x *= .8,
                    ...
                    var A = function() {
                      ...
                      , k = function(i, n) {
                        ...
                        this.scrollbarXTop = m(d.top)) : this.isScrollbarXUsingBottom = !0,
                        ...
                        this.scrollbarYLeft = m(f.left)) : this.isScrollbarYUsingRight = !0,
