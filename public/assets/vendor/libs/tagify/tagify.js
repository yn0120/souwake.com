!function(t, e) {
    ...
    return function() {
        ...
        function s(t) {
            return function(t) {
                ...
                if (t) {
                    ...
                    "Map" === i || "Set" === i ? Array.from(i) : "Arguments" === i || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(i) ? n(t, e) : void 0
                }
            }(t) || function() {
        ...
        function O(t, e, i) {
            return t ? (e && (t.__tagifyTagData = i ? e : h({}, t.__tagifyTagData || {}, e)),
            t.__tagifyTagData) : (a.warn("tag element doesn't exist", {
                tagElm: t,
                data: e
            }),
            e)
        ...
        function E(t, e) {
            return e = null != e ? e : {},
            Object.getOwnPropertyDescriptors ? Object.defineProperties(t, Object.getOwnPropertyDescriptors(e)) : function(t) {
                var e = Object.keys(t);
        ...
        var C, k, L = (C = function(t) {
                        ...
                        if (this.state.hasFocus && !this.state.composing) {
                            ...
                            i.hooks.beforeKeyDown(t, {
                                ...
                                case "Up":
                                    ...
                                    n && n.matches(i.classNames.dropdownItemSelector) || (n = d[c ? d.length - 1 : 0]),
                                ...
                                case "Tab":
                                    ...
                                    if (!o && !r && n && b && !e.state.editing && s) {
                                        ...
                                        return e.state.autoCompleteData = s,
                                ...
                                case "Enter":
                                    ...
                                    i.hooks.suggestionClick(t, {
                                        ...
                                        if (n)
                                            return e.dropdown.selectOption(n),
            ...
            filterListItems: function(t, e) {
                ...
                }, d = this, c = this.settings, u = c.dropdown, h = (e = e || {},
                []), p = [], m = c.whitelist, v = u.maxItems >= 0 ? u.maxItems : 1 / 0, b = u.includeSelectedTags || "select" == c.mode, y = "function" == typeof u.sortby, w = u.searchKeys, T = 0;
                ...
                for (r = u.caseSensitive ? "" + t : ("" + t).toLowerCase(); T < m.length; T++)
                    i = this,
                    l();
                return this.state.dropdown.suggestions = p.concat(h),
            ...
            createListHTML: function(t) {
                ...
                return h([], t).map((function(t, i) {
                    ...
                    return n = "string" == typeof n && e.settings.dropdown.escapeHTML ? u(n) : n,
                    e.settings.templates.dropdownItem.apply(e, [E(M({}, t), {
                        mappedValue: n
                    }), e])
                }
                )).join("")
        ...
        k = null != (k = {
            ...
            show: function(t) {
                var e, i, n, s = this, a = this.settings, r = "mix" == a.mode && !a.enforceWhitelist, l = !a.whitelist || !a.whitelist.length, d = "manual" == a.dropdown.position;
                if (t = void 0 === t ? this.state.inputText : t,
                !(l && !r && !a.templates.dropdownItemNoMatch || !1 === a.dropdown.enabled || this.state.isLoading || this.settings.readonly)) {
                    if (clearTimeout(this.dropdownHide__bindEventsTimeout),
                    this.suggestedListItems = this.dropdown.filterListItems(t),
                    t && !this.suggestedListItems.length && (this.trigger("dropdown:noMatch", t),
                    a.templates.dropdownItemNoMatch && (n = a.templates.dropdownItemNoMatch.call(this, {
                        value: t
                    }))),
                    !n) {
                        if (this.suggestedListItems.length)
                            t && r && !this.state.editing.scope && !o(this.suggestedListItems[0].value, t) && this.suggestedListItems.unshift({
                                value: t
                            });
                        else {
                    ...
                    a.dropdown.highlightFirst && this.dropdown.highlightOption(this.DOM.dropdown.content.querySelector(a.classNames.dropdownItemSelector)),
            ...
            render: function() {
                var t, e, i = this, n = ((e = this.DOM.dropdown.cloneNode(!0)).style.cssText = "position:fixed; top:-9999px; opacity:0",
                document.body.appendChild(e),
                t = e.clientHeight,
                e.parentNode.removeChild(e),
                t), s = this.settings, a = this.dropdown.getAppendTarget();
                return !1 === s.dropdown.enabled || (this.DOM.scope.setAttribute("aria-expanded", !0),
        ...
        Object.getOwnPropertyDescriptors ? Object.defineProperties(C, Object.getOwnPropertyDescriptors(k)) : function(t) {
            var e = Object.keys(t);
            if (Object.getOwnPropertySymbols) {
                var i = Object.getOwnPropertySymbols(t);
                e.push.apply(e, i)
        ...
        var K = {
            ...
            callbacks: {
                onFocusBlur: function(t) {
                    var e, i, n = this.settings, s = y.call(this, t.relatedTarget), a = b.call(this, t.relatedTarget), o = t.target.classList.contains(n.classNames.tagX), r = "focusin" == t.type, l = "focusout" == t.type;
                    ...
                    if (!(h || p || o))
                        ...
                        "mix" != n.mode) {
                            if (r) {
                                ...
                                void (f && m && this.dropdown.show(this.value.length ? "" : void 0))
                            }
                            if (l) {
                ...
                onWindowKeyDown: function(t) {
                    var e, i = this.settings, n = document.activeElement, s = y.call(this, n) && this.DOM.scope.contains(n), a = n === this.DOM.input, o = s && n.hasAttribute("readonly");
                        ...
                        i.hooks.beforeKeyDown(t, {
                            ...
                            if ("mix" == i.mode) {
                                ...
                                case "Backspace":
                                    ...
                                    var d, u, g, h = e.getTagElms(), p = 1 === a.anchorNode.length && a.anchorNode.nodeValue == String.fromCharCode(8203);
                                    if ("edit" == i.backspace && l)
                                        return d = 1 == a.anchorNode.nodeType ? null : a.anchorNode.previousElementSibling,
                                    ...
                                    if ("BR" == a.anchorNode.nodeName)
                                        return;
                                    if ((o || l) && 1 == a.anchorNode.nodeType ? u = 0 == a.anchorOffset ? o ? h[0] : null : h[Math.min(h.length, a.anchorOffset) - 1] : o ? u = a.anchorNode.nextElementSibling : W(l, Element) && (u = l),
                            ...
                            case "Enter":
                                ...
                                setTimeout((function() {
                                    e.state.dropdown.visible && !f || e.state.actions.selectOption || !i.addTagOn.includes(t.key.toLowerCase()) || (e.addTags([b], !0),
                ...
                onMixTagsInput: function(t) {
                    var e, i, n, s, a, o, r, l, d = this, c = this.settings, u = this.value.length, g = this.getTagElms(), p = document.createDocumentFragment(), f = window.getSelection().getRangeAt(0), v = [].map.call(g, (function(t) {
                        return O(t).value
                    }
                    ));
                    ...
                    p.childNodes.length && (f.insertNode(p),
                    ...
                    if (window.getSelection && (o = window.getSelection()).rangeCount > 0 && 3 == o.anchorNode.nodeType) {
                        if ((f = o.getRangeAt(0).cloneRange()).collapse(!0),
                ...
                onClickScope: function(t) {
                    ...
                    if (n && "select" != e.mode)
                        ...
                        if (!t.target.classList.contains(e.classNames.tagX))
                            ...
                            s > 500 || !e.focusable) ? this.state.dropdown.visible ? this.dropdown.hide() : 0 === e.dropdown.enabled && "mix" != e.mode && this.dropdown.show(this.value.length ? "" : void 0) : "select" != e.mode || 0 !== e.dropdown.enabled || this.state.dropdown.visible || (this.events.callbacks.onDoubleClickScope.call(this, function(t, e) {
                                return e = null != e ? e : {},
                                Object.getOwnPropertyDescriptors ? Object.defineProperties(t, Object.getOwnPropertyDescriptors(e)) : function(t) {
                                    var e = Object.keys(t);
                                    if (Object.getOwnPropertySymbols) {
                ...
                onEditTagInput: function(t, e) {
                    var i, n = t.closest("." + this.settings.classNames.tag), s = this.getNodeIndex(n), a = O(n), o = this.input.normalize.call(this, t), r = (B(i = {}, this.settings.tagTextProp, o),
                ...
                onEditTagBlur: function(t, e) {
                    ...
                    this.DOM.scope.contains(t))) {
                        var n, s, a, o = this.settings, r = t.closest("." + o.classNames.tag), l = O(r), d = this.input.normalize.call(this, t), c = (B(n = {}, o.tagTextProp, d),
                        B(n, "__tagId", l.__tagId),
                        n), u = l.__originalData, g = this.editTagChangeDetected(h(l, c)), p = this.validateTag(c);
                        if (d)
                            if (g) {
                                var f;
                                if (s = this.hasMaxTags(),
                                a = h({}, u, (B(f = {}, o.tagTextProp, this.trim(d)),
                                B(f, "__isValid", p),
                                f)),
                ...
                onDoubleClickScope: function(t) {
                    var e, i, n = t.target.closest("." + this.settings.classNames.tag), s = O(n), a = this.settings;
                ...
                onInputDOMChange: function(t) {
                    ...
                    t.forEach((function(t) {
                        ...
                        t.removedNodes.forEach((function(t) {
                            t && "BR" == t.nodeName && b.call(e, i) && (e.removeTags(i),
        ...
        function G(t) {
            return function(t) {
                ...
                if (t) {
                    ...
                    var i = Object.prototype.toString.call(t).slice(8, -1);
                    return "Object" === i && t.constructor && (i = t.constructor.name),
                    "Map" === i || "Set" === i ? Array.from(i) : "Arguments" === i || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(i) ? q(t, e) : void 0
                }
            }(t) || function() {
                throw new TypeError("Invalid attempt to spread non-iterable instance.\\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")
            }()
        ...
        function $(t, e) {
            ...
            if (t.__tagify)
                return a.warn("input element is already Tagified - Same instance is returned.", t),
                t.__tagify;
            var n;
            h(this, function(t) {
                        ...
                        i)
                            if (t.settings.isJQueryPlugin)
                                ...
                                try {
                                    ...
                                    if ((r = s.cloneData ? h({}, r) : r).tagify = this,
                                    n.event && (r.event = this.cloneEvent(n.event)),
                                    F(n, Object))
                                        for (var l in n)
                                            F(n[l], HTMLElement) && (r[l] = n[l]);
                                    o = new CustomEvent(i,{
                                        detail: r
                                    })
                                } catch (t) {
            ...
            this.setPersistedData = function(t) {
                var e;
                return t ? (null === (e = localStorage) || void 0 === e || e.setItem(j + t + "/v", 1),
                function(e, i) {
                    var n, s = "/" + i, a = JSON.stringify(e);
                    e && i && (null === (n = localStorage) || void 0 === n || n.setItem(j + t + s, a),
        ...
        $.prototype = {
            ...
            applySettings: function(t, e) {
                ...
                "autoComplete"in e && !g(e.autoComplete) && (a.autoComplete = S.autoComplete,
            ...
            getCustomAttributes: function(t) {
                ...
                var e, i = {};
                for (e in t)
                    "__" != e.slice(0, 2) && "class" != e && t.hasOwnProperty(e) && void 0 !== t[e] && (i[e] = u(t[e]));
                return i
            },
            ...
            editTag: function(t, e) {
                ...
                s) {
                    ...
                    a.warn("Cannot find element in Tag template: .", n.classNames.tagTextSelector)
            },
            ...
            onEditTagDone: function(t, e) {
                ...
                a.a11y.focusableTags ? t.focus() : "select" != a.mode && x(t)) : t && this.removeTags(t),
            ...
            input: {
                set: function() {
                    ...
                    e && (this.DOM.input.innerHTML = u("" + t),
            ...
            normalizeTags: function(t) {
                ...
                return l && !c && (t.forEach((function(t) {
                    ...
                    s && X(s, Object) ? r.push(s) : "mix" != a && (null == t.value && (t.value = t[o]),
                    r.push(t))
                }
                )),
                r.length && (t = r)),
            ...
            replaceTextWithNode: function(t, e) {
                if (this.state.tag || e) {
                    ...
                    -1 == (i = a.nodeValue.lastIndexOf(e)) || (n = a.splitText(i),
