                ...
                "object" == typeof navigator && (e.exports = function() {
                    ...
                    function L(e={}, ...t) {
                        if (!t.length)
                            return e;
                        const i = t.shift();
                        return E.object(i) ? (Object.keys(i).forEach((t => {
                            E.object(i[t]) ? (Object.keys(e).includes(t) || Object.assign(e, {
                                [t]: {}
                            }),
                            L(e[t], i[t])) : Object.assign(e, {
                                [t]: i[t]
                            })
                        }
                        )),
                    ...
                    function $(e, t) {
                        E.element(e) && !E.empty(t) && Object.entries(t).filter(( ([,e]) => !E.nullOrUndefined(e))).forEach(( ([t,i]) => e.setAttribute(t, i)))
                    }
                    function O(e, t, i) {
                        const s = document.createElement(e);
                        return E.object(t) && $(s, t),
                        E.string(i) && (s.innerText = i),
                        s
                    }
                    function _(e, t, i, s) {
                    ...
                    function j(e) {
                        E.nodeList(e) || E.array(e) ? Array.from(e).forEach(j) : E.element(e) && E.element(e.parentNode) && e.parentNode.removeChild(e)
                    }
                    function q(e) {
                        if (!E.element(e))
                            return;
                    ...
                    const K = {
                      ...
                      , Y = {
                        ...
                        pip: !(x.isIPhone || !E.function(O("video").webkitSetPresentationMode) && (!document.pictureInPictureEnabled || O("video").disablePictureInPicture)),
                    ...
                    function X(e, t, i, s=!1, n=!0, a=!1) {
                        if (!e || !("addEventListener"in e) || E.empty(t) || !E.function(i))
                            return;
                        const l = t.split(" ");
                        let r = a;
                        Q && (r = {
                    ...
                    const re = [[1, 1], [4, 3], [3, 4], [5, 4], [4, 5], [3, 2], [2, 3], [16, 10], [10, 16], [16, 9], [9, 16], [21, 9], [9, 21], [32, 9], [9, 32]].reduce(( (e, [t,i]) => ({
                        ...e,
                        [t / i]: [t, i]
                    })), {});
                    function oe(e) {
                    ...
                    function he(e) {
                        ...
                        const [s,n] = ce(i)
                          , a = 100 / s * n;
                        if (le(`aspect-ratio: ${s}/${n}`) ? t.style.aspectRatio = `${s}/${n}` : t.style.paddingBottom = `${a}%`,
                    ...
                    const Me = {
                        ...
                        findElements() {
                            try {
                                ...
                                E.element(this.elements.progress) && (this.elements.display.seekTooltip = this.elements.progress.querySelector(`.${this.config.classNames.tooltip}`)),
                                !0
                            } catch (e) {
                        ...
                        createButton(e, t) {
                            ...
                            Object.keys(i).includes("class") ? i.class.split(" ").some((e => e === this.config.classNames.control)) || L(i, {
                            ...
                            $(a, i),
                            "play" === s ? (E.array(this.elements.buttons[s]) || (this.elements.buttons[s] = []),
                            this.elements.buttons[s].push(a)) : this.elements.buttons[s] = a,
                            a
                        },
                        createRange(e, t) {
                            const i = O("input", L(H(this.config.selectors.inputs[e]), {
                                type: "range",
                                min: 0,
                                max: 100,
                                step: .01,
                        ...
                        createProgress(e, t) {
                            const i = O("progress", L(H(this.config.selectors.display[e]), {
                                min: 0,
                                max: 100,
                                value: 0,
                                role: "progressbar",
                        ...
                        createMenuItem({value: e, list: t, type: i, title: s, badge: n=null, checked: a=!1}) {
                            ...
                            Object.defineProperty(r, "checked", {
                                ...
                                set(e) {
                                    e && Array.from(r.parentNode.children).filter((e => U(e, '[role="menuitemradio"]'))).forEach((e => e.setAttribute("aria-checked", "false"))),
                        ...
                        updateVolume() {
                            this.supported.ui && (E.element(this.elements.inputs.volume) && Me.setRange.call(this, this.elements.inputs.volume, this.muted ? 0 : this.volume),
                        ...
                        updateSetting(e, t, i) {
                            ...
                            if (E.element(a) || (a = s && s.querySelector('[role="menu"]')),
                            !E.element(a))
                                return;
                        ...
                        toggleMenu(e) {
                            ...
                            if (!E.element(t) || !E.element(i))
                                return;
                            const {hidden: s} = t;
                            let n = s;
                            if (E.boolean(e))
                                n = e;
                            else if (E.keyboardEvent(e) && "Escape" === e.key)
                                n = !1;
                            else if (E.event(e)) {
                            ...
                            n && E.keyboardEvent(e) ? Me.focusFirstMenuItem.call(this, null, !0) : n || s || z.call(this, i, E.keyboardEvent(e))
                        },
                        getMenuSize(e) {
                        ...
                        create(e) {
                            const {bindMenuItemShortcuts: t, createButton: i, createProgress: s, createRange: n, createTime: a, setQualityMenu: l, setSpeedMenu: r, showMenuPanel: o} = Me;
                            this.elements.controls = null,
                            E.array(this.config.controls) && this.config.controls.includes("play-large") && this.elements.container.appendChild(i.call(this, "play-large"));
                            const c = O("div", H(this.config.selectors.controls.wrapper));
                            this.elements.controls = c;
                            const u = {
                                class: "plyr__controls__item"
                            };
                            return ne(E.array(this.config.controls) ? this.config.controls : []).forEach((l => {
                                ...
                                "mute" === l || "volume" === l) {
                                    ...
                                    if (E.element(t) && c.contains(t) || (t = O("div", L({}, u, {
                                    ...
                                    "volume" === l && !x.isIos && !x.isIPadOS) {
                                        ...
                                        t.appendChild(n.call(this, "volume", L(i, {
                                            id: `plyr-volume-${e.id}`
                                        })))
                                    }
                                }
                                ...
                                "settings" === l && !E.empty(this.config.settings)) {
                                    ...
                                    this.config.settings.forEach((i => {
                                        const s = O("button", L(H(this.config.selectors.buttons.settings), {
                                            type: "button",
                                ...
                                if ("pip" === l && Y.pip && c.appendChild(i.call(this, "pip", u)),
                        ...
                        inject() {
                            ...
                            let i, s = !0;
                            if (E.function(this.config.controls) && (this.config.controls = this.config.controls.call(this, t)),
                            this.config.controls || (this.config.controls = []),
                            E.element(this.config.controls) || E.string(this.config.controls) ? e = this.config.controls : (e = Me.create.call(this, {
                                id: this.id,
                                seektime: this.config.seekTime,
                                speed: this.speed,
                            ...
                            s = !1),
                            s && E.string(this.config.controls) && (e = (e => {
                                let i = e;
                            ...
                            E.string(this.config.selectors.controls.container) && (i = document.querySelector(this.config.selectors.controls.container)),
                    ...
                    function Ne(e) {
                        ...
                        return E.object(e) && Object.entries(e).forEach(( ([e,i]) => {
                            t.set(e, i)
                        }
                        )),
                        t
                    ...
                    const Le = {
                        setup() {
                            ...
                            if (!this.isVideo || this.isYouTube || this.isHTML5 && !Y.textTracks)
                                return void (E.array(this.config.controls) && this.config.controls.includes("settings") && this.config.settings.includes("captions") && Me.setCaptionsMenu.call(this));
                            var e, t;
                            ...
                            if (E.boolean(n) || ({active: n} = this.config.captions),
                        ...
                        update() {
                            ...
                            (a && this.language !== i || !e.includes(n)) && (Le.setLanguage.call(this, i),
                            Le.toggle.call(this, t && a)),
                            this.elements && F(this.elements.container, this.config.classNames.captions.enabled, !E.empty(e)),
                            E.array(this.config.controls) && this.config.controls.includes("settings") && this.config.settings.includes("captions") && Me.setCaptionsMenu.call(this)
                        },
                        toggle(e, t=!0) {
                            if (!this.supported.ui)
                                return;
                        ...
                        getLabel(e) {
                            let t = e;
                            return !E.track(t) && Y.textTracks && this.captions.toggled && (t = Le.getCurrentTrack.call(this)),
                            E.track(t) ? E.empty(t.label) ? E.empty(t.language) ? we.get("enabled", this.config) : e.language.toUpperCase() : t.label : we.get("disabled", this.config)
                        },
                        updateCues(e) {
                            if (!this.supported.ui)
                                return;
                    ...
                    class Re {
                        constructor(t) {
                            ...
                            e(this, "update", ( () => {
                                if (this.supported) {
                                    let e;
                                    e = this.forceFallback ? "Fallback (forced)" : Re.nativeSupported ? "Native" : "Fallback",
                            ...
                            e(this, "enter", ( () => {
                                this.supported && (x.isIos && this.player.config.fullscreen.iosNative ? this.player.isVimeo ? this.player.embed.requestFullscreen() : this.target.webkitEnterFullscreen() : !Re.nativeSupported || this.forceFallback ? this.toggleFallback(!0) : this.prefix ? E.empty(this.prefix) || this.target[`${this.prefix}Request${this.property}`]() : this.target.requestFullscreen({
                                    navigationUI: "hide"
                                }))
                            }
                            )),
                            ...
                            J.call(this.player, this.player.elements.container, "dblclick", (e => {
                                E.element(this.player.elements.controls) && this.player.elements.controls.contains(e.target) || this.player.listeners.proxy(e, this.toggle, "fullscreen")
                            }
                            )),
                        ...
                        static get prefix() {
                            if (E.function(document.exitFullscreen))
                                return "";
                            let e = "";
                            return ["webkit", "moz", "ms"].some((t => !(!E.function(document[`${t}ExitFullscreen`]) && !E.function(document[`${t}CancelFullScreen`]) || (e = t,
                            0)))),
                            e
                        }
                        static get property() {
                        ...
                        get supported() {
                            return [this.player.config.fullscreen.enabled, this.player.isVideo, Re.nativeSupported || this.player.config.fullscreen.fallback, !this.player.isYouTube || Re.nativeSupported || !x.isIos || this.player.config.playsinline && !this.player.config.fullscreen.iosNative].every(Boolean)
                        }
                        get active() {
                            if (!this.supported)
                                return !1;
                    ...
                    const Ve = {
                        ...
                        build() {
                            ...
                            E.element(this.elements.controls) || (Me.inject.call(this),
                        ...
                        setTitle() {
                            ...
                            if (E.string(this.config.title) && !E.empty(this.config.title) && (e += `, ${this.config.title}`),
                        ...
                        setPoster(e, t=!0) {
                            ...
                            ie.call(this).then(( () => Fe(e))).catch((t => {
                                throw e === this.poster && Ve.togglePoster.call(this, !1),
                                t
                            }
                            )).then(( () => {
                                if (e !== this.poster)
                        ...
                        migrateStyles() {
                            Object.values({
                                ...this.media.style
                            }).filter((e => !E.empty(e) && E.string(e) && e.startsWith("--plyr"))).forEach((e => {
                        ...
                        constructor(t) {
                            ...
                            e(this, "container", ( () => {
                                ...
                                J.call(e, i.container, "mousemove mouseleave touchstart touchmove enterfullscreen exitfullscreen", (t => {
                                    ...
                                    n.hover = !1);
                                    let a = 0;
                                    ["touchstart", "touchmove", "mousemove"].includes(t.type) && (Ve.toggleControls.call(e, !0),
                                    a = e.touch ? 3e3 : 2e3),
                                ...
                                J.call(e, i.container, "enterfullscreen exitfullscreen", (t => {
                                    ...
                                    s === i.container && (!e.isEmbed && E.empty(e.config.ratio) || (n(),
                            ...
                            e(this, "media", ( () => {
                                ...
                                J.call(e, e.media, "playing play pause ended emptied timeupdate", (t => Ve.checkPlaying.call(e, t))),
                            ...
                            e(this, "controls", ( () => {
                                ...
                                this.bind(t.inputs.seek, "mousedown mouseup keydown keyup touchstart touchend", (t => {
                                    const i = t.currentTarget
                                      , s = "play-on-seeked";
                                    if (E.keyboardEvent(t) && !["ArrowLeft", "ArrowRight"].includes(t.key))
                                        return;
                                    e.lastSeekTime = Date.now();
                                ...
                                e.config.toggleInvert && !E.element(t.display.duration) && this.bind(t.display.currentTime, "click", ( () => {
                    ...
                    const Ke = {
                        setup() {
                            ...
                            e.options.speed = e.config.speed.options,
                            he.call(e),
                            E.object(window.Vimeo) ? Ke.ready.call(e) : We(e.config.urls.vimeo.sdk).then(( () => {
                                Ke.ready.call(e)
                            }
                            )).catch((t => {
                        ...
                        ready() {
                            ...
                            let a = e.media.getAttribute("src")
                              , l = "";
                            E.empty(a) ? (a = e.media.getAttribute(e.config.attributes.embed.id),
                            ...
                            const o = Ne({
                              ...
                              , c = (u = a,
                            E.empty(u) ? null : E.number(Number(u)) ? u : u.match(/^.*(vimeo.com\/|video\/)(\d+).*/) ? RegExp.$2 : u);
                            var u;
                            const h = O("iframe")
                            ...
                            e.embed.on("loaded", ( () => {
                                ...
                                E.element(e.embed.element) && e.supported.ui && e.embed.element.setAttribute("tabindex", -1)
                            }
                            )),
                    ...
                    const Xe = {
                        ...
                        ready() {
                            ...
                            if (!E.empty(i) && i.startsWith("youtube-"))
                                return;
                            let s = e.media.getAttribute("src");
                            E.empty(s) && (s = e.media.getAttribute(this.config.attributes.embed.id));
                            const n = (a = s,
                            E.empty(a) ? null : a.match(/^.*(youtu.be\/|v\/|u\/\w\/|embed\/|watch\?v=|&v=)([^#&?]*).*/) ? RegExp.$2 : a);
                            var a;
                            const l = O("div", {
                                id: `${e.provider}-${Math.floor(1e4 * Math.random())}`,
                                "data-poster": t.customControls ? e.poster : void 0
                            });
                            if (e.media = D(l, e.media),
                            t.customControls) {
                                const t = e => `https://i.ytimg.com/vi/${n}/${e}default.jpg`;
                                Fe(t("maxres"), 121).catch(( () => Fe(t("sd"), 121))).catch(( () => Fe(t("hq")))).then((t => Ve.setPoster.call(e, t.src))).then((t => {
                    ...
                    class Ge {
                        constructor(t) {
                            e(this, "load", ( () => {
                                this.enabled && (E.object(window.google) && E.object(window.google.ima) ? this.ready() : We(this.player.config.urls.googleIMA.sdk).then(( () => {
                                    this.ready()
                                }
                                )).catch(( () => {
                            ...
                            e(this, "addCuePoints", ( () => {
                                E.empty(this.cuePoints) || this.cuePoints.forEach((e => {
                            ...
                            e(this, "listeners", ( () => {
                                ...
                                this.player.on("seeked", ( () => {
                                    ...
                                    E.empty(this.cuePoints) || this.cuePoints.forEach(( (i, s) => {
                            ...
                            e(this, "trigger", ( (e, ...t) => {
                                ...
                                E.array(i) && i.forEach((e => {
                                    E.function(e) && e.apply(this, t)
                                }
                                ))
                            }
                            )),
                            e(this, "on", ( (e, t) => (E.array(this.events[e]) || (this.events[e] = []),
                            ...
                            e(this, "clearSafetyTimer", (e => {
                                E.nullOrUndefined(this.safetyTimer) || (this.player.debug.log(`Safety timer cleared from: ${e}`),
                        ...
                        get tagUrl() {
                            const {config: e} = this;
                            return E.url(e.tagUrl) ? e.tagUrl : `https://go.aniview.com/api/adserver6/vast/?${Ne({
                    ...
                    class it {
                        constructor(t) {
                            ...
                            e(this, "startScrubbing", (e => {
                                (E.nullOrUndefined(e.button) || !1 === e.button || 0 === e.button) && (this.mouseDown = !0,
                            ...
                            e(this, "render", ( () => {
                                ...
                                E.element(this.player.elements.progress) && this.player.elements.progress.appendChild(this.elements.thumb.container),
                    ...
                    const st = {
                        insertElements(e, t) {
                            E.string(t) ? _(e, this.media, {
                                src: t
                            }) : E.array(t) && t.forEach((t => {
                                _(e, this.media, t)
                            }
                            ))
                        },
                        change(e) {
                            N(e, "sources.length") ? (me.cancelRequests.call(this),
                            this.destroy.call(this, ( () => {
                                this.options.quality = [],
                                j(this.media),
                                this.media = null,
                                E.element(this.elements.container) && this.elements.container.removeAttribute("class");
                                ...
                                E.empty(e.previewThumbnails) || (Object.assign(this.config.previewThumbnails, e.previewThumbnails),
                    ...
                    class nt {
                        constructor(t, i) {
                            if (e(this, "play", ( () => E.function(this.media.play) ? (this.ads && this.ads.enabled && this.ads.managerPromise.then(( () => this.ads.play())).catch(( () => se(this.media.play()))),
                            ...
                            e(this, "toggleControls", (e => {
                                if (this.supported.ui && !this.isAudio) {
                                    ...
                                    if (s && E.array(this.config.controls) && this.config.controls.includes("settings") && !E.empty(this.config.settings) && Me.toggleMenu.call(this, !1),
                                    s !== t) {
                            ...
                            e(this, "destroy", ( (e, t=!1) => {
                                ...
                                this.isHTML5 ? (Ve.toggleNativeControls.call(this, !0),
                            ...
                            this.config = L({}, Ie, nt.defaults, i || {}, ( () => {
                                try {
                        ...
                        set download(e) {
                            E.url(e) && (this.config.urls.download = e,
                            Me.setDownloadUrl.call(this))
                        }
                        set poster(e) {
                            this.isVideo ? Ve.setPoster.call(this, e, !1).catch(( () => {}
                        ...
                        set ratio(e) {
                            this.isVideo ? E.string(e) && oe(e) ? (this.config.ratio = ce(e),
                        ...
                        get pip() {
                            return Y.pip ? E.empty(this.media.webkitPresentationMode) ? this.media === document.pictureInPictureElement : this.media.webkitPresentationMode === $e : null
                        }
