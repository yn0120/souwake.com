                ...
                (e = jQuery).idleTimer = function(t, i, n) {
                    ...
                    var o = e(i)
                      ...
                      , d = function(t) {
                        ...
                        if (("storage" !== t.type || t.originalEvent.key === r.timerSyncId) && null == r.remaining) {
                            if ("mousemove" === t.type) {
                                if (t.pageX === r.pageX && t.pageY === r.pageY)
                                    return;
                                if (void 0 === t.pageX && void 0 === t.pageY)
                                    return;
                                if (+new Date - r.olddate < 200)
                                    return
                            }
                            clearTimeout(r.tId),
                            r.idle && l(t),
                            ...
                            r.pageX = t.pageX,
                            r.pageY = t.pageY,
                            "storage" !== t.type && r.timerSyncId && "undefined" != typeof localStorage && localStorage.setItem(r.timerSyncId, r.lastActive),
                    ...
                    if (null === t)
                        ...
                        if ("pause" === t)
                            return function() {
                                var t = e.data(i, "idleTimerObj" + n) || {};
                                null == t.remaining && (t.remaining = t.timeout - (+new Date - t.olddate),
                                clearTimeout(t.tId))
                            }(),
                            o;
                        if ("resume" === t)
                            return function() {
                                var t = e.data(i, "idleTimerObj" + n) || {};
                                null != t.remaining && (t.idle || (t.tId = setTimeout(l, t.remaining)),
                                t.remaining = null)
                            }(),
                            o;
                        if ("reset" === t)
                        ...
                        if ("getLastActiveTime" === t)
                            return a.lastActive;
                        if ("isIdle" === t)
                            return a.idle
                    }
                    return o.on((r.events + " ").split(" ").join("._idleTimer" + n + " ").trim(), (function(e) {
                        d(e)
                    }
                    )),
