                ...
                e.exports = function() {
                    ...
                    function I(p, v) {
                        ...
                        function _() {
                            ...
                            b.isMobile || V(),
                            K(),
                            (b.selectedDates.length || b.config.noCalendar) && (b.config.enableTime && L(b.config.noCalendar ? b.latestSelectedDateObj : void 0),
                            Ge(!1)),
                            N();
                        ...
                        function K() {
                            ...
                            b.isMobile)
                                ...
                                var e = l(Ce, 50);
                                if (b._debouncedChange = l(J, S),
                                b.daysContainer && !/iPhone|iPad|iPod/i.test(navigator.userAgent) && B(b.daysContainer, "mouseover", (function(e) {
                                ...
                                void 0 !== window.ontouchstart ? B(window.document, "touchstart", pe) : B(window.document, "mousedown", pe),
                                B(window.document, "focus", pe, {
                                    capture: !0
                                }),
                                !0 === b.config.clickOpens && (B(b._input, "focus", b.open),
                                B(b._input, "click", b.open)),
                                void 0 !== b.daysContainer && (B(b.monthNav, "click", Ze),
                                ...
                                void 0 !== b.timeContainer && void 0 !== b.minuteElement && void 0 !== b.hourElement) {
                                    ...
                                    void 0 !== b.secondElement && B(b.secondElement, "focus", (function() {
                        ...
                        function U(e, t) {
                            ...
                            t && b.currentYear !== a && (Ke("onYearChange"),
                            ne()),
                        ...
                        function oe() {
                            return b.monthNav = d("div", "flatpickr-months"),
                            b.yearElements = [],
                            b.monthElements = [],
                        ...
                        function re() {
                            ...
                            b.hourElement.value = o(b.latestSelectedDateObj ? b.latestSelectedDateObj.getHours() : b.config.time_24hr ? e.hours : j(e.hours)),
                        ...
                        function pe(e) {
                            if (b.isOpen && !b.config.inline) {
                                ...
                                void 0 !== b.timeContainer && void 0 !== b.minuteElement && void 0 !== b.hourElement && "" !== b.input.value && void 0 !== b.input.value && P(),
                                b.close(),
                        ...
                        function we(e) {
                            ...
                            if (13 === e.keyCode && n) {
                                ...
                                case 40:
                                    ...
                                    he(b.currentYear - s),
                                    X(Z(1), 0)) : r || X(void 0, 7 * s) : t === b.currentYearElement ? he(b.currentYear - s) : b.config.enableTime && (!r && b.hourElement && b.hourElement.focus(),
                                    P(e),
                                    b._debouncedChange());
                                    break;
                                case 9:
                        ...
                        function Ee() {
                            ...
                            u = 0; u < b.config.plugins.length; u++) {
                                ...
                                for (var m in f)
                                    n.indexOf(m) > -1 ? b.config[m] = c(f[m]).map(A).concat(b.config[m]) : void 0 === i[m] && (b.config[m] = f[m])
                            }
                        ...
                        function Oe() {
                            b.config.noCalendar || b.isMobile || (ne(),
                            Ve(),
                            te())
                        }
                        function Fe() {
                        ...
                        function Ae(e) {
                            ...
                            if (void 0 !== n) {
                                ...
                                "single" === b.config.mode)
                                    ...
                                    0 !== C(i, b.selectedDates[0], !0) && b.selectedDates.sort((function(e, t) {
                                ...
                                te(),
                                Ge(),
                                o || "range" === b.config.mode || 1 !== b.config.showMonths ? void 0 !== b.selectedDateElem && void 0 === b.hourElement && b.selectedDateElem && b.selectedDateElem.focus() : G(a),
                        ...
                        var Ne = {
                            ...
                            clickOpens: [function() {
                                !0 === b.config.clickOpens ? (B(b._input, "focus", b.open),
                                B(b._input, "click", b.open)) : (b._input.removeEventListener("focus", b.open),
                        ...
                        function Pe(e, t) {
                            if (null !== e && "object" == typeof e)
                                ...
                                e)
                                    void 0 !== Ne[a] && Ne[a].forEach((function(e) {
                                        return e()
                                    }
                                    ));
                            else
                                b.config[e] = t,
                                void 0 !== Ne[e] ? Ne[e].forEach((function(e) {
                                    return e()
                                }
                        ...
                        function Ke(e, t) {
                            if (void 0 !== b.config) {
                                ...
                                "onChange" === e && (b.input.dispatchEvent(Ue("change")),
                        ...
                        function Qe(e) {
                            ...
                            if (void 0 !== a.value && 2 === a.value.length) {
                                ...
                                f && $(void 0, -1, b.hourElement)) : d > l && (d = a === b.hourElement ? d - l - r(!b.amPM) : i,
