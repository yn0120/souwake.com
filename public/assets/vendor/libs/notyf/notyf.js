!function(t, i) {
    ...
    return function() {
        ...
        var t = {
            d: function(i, e) {
                for (var n in e)
                    t.o(e, n) && !t.o(i, n) && Object.defineProperty(i, n, {
                        enumerable: !0,
                        get: e[n]
                    })
            },
        ...
        var a = {
          ...
          , c = function() {
            ...
            return t.prototype.on = function(t, i) {
                var e;
                this.events = n(n({}, this.events), ((e = {})[t] = i,
                e))
            }
            ,
            ...
            t.prototype.removeNotification = function(t) {
                ...
                i.addEventListener(this.animationEndEventName, e = function(t) {
                    t.target === i && (i.removeEventListener(n.animationEndEventName, e),
            ...
            t.prototype._renderNotification = function(t) {
                ...
                return n && (i = e.classList).add.apply(i, n.split(" ")),
            ...
            t.prototype._buildNotificationCard = function(t) {
                ...
                if (n) {
                    ...
                    if (("string" == typeof n || n instanceof String) && (f.innerHTML = new String(n).valueOf()),
                    "object" == typeof n) {
                        var u = n.tagName
                          , d = void 0 === u ? "i" : u
                          , l = n.className
                ...
                if (a.appendChild(c),
                o.appendChild(a),
                p && (e.ripple ? (r.style.background = p,
                o.appendChild(r)) : o.style.background = p),
                e.dismissible) {
                    ...
                    g.addEventListener("click", (function(e) {
                        var n, o;
                        null === (o = (n = i.events)[s.Dismiss]) || void 0 === o || o.call(n, {
                            target: t,
                            event: e
                        }),
                        e.stopPropagation()
                ...
                o.addEventListener("click", (function(e) {
                    var n, o;
                    return null === (o = (n = i.events)[s.Click]) || void 0 === o ? void 0 : o.call(n, {
                        target: t,
                        event: e
                    })
                }
                ...
                return o.classList.add("notyf__toast--" + N),
                o
            }
            ,
          ...
          , p = function() {
            ...
            t.prototype.open = function(t) {
                var i = this.options.types.find((function(i) {
            ...
            t.prototype.normalizeOptions = function(t, i) {
                ...
                return "string" == typeof i ? e.message = i : "object" == typeof i && (e = n(n({}, e), i)),
                e
            }
            ,
            t.prototype.registerTypes = function(t) {
                var i = (t && t.types || []).slice();
                return a.types.map((function(t) {
                    var e = -1;
