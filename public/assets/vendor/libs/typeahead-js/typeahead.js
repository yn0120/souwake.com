                ...
                r = function(t) {
                    ...
                    c = window.SearchIndex = function() {
                        ...
                        return n.mixin(r.prototype, {
                            ...
                            search: function(e) {
                                var r, o, c = this;
                                return r = s(this.queryTokenizer(e)),
                                n.each(r, (function(e) {
                                    var n, r, s, u;
                                    if (o && 0 === o.length)
                                        return !1;
                                    for (n = c.trie,
                                    r = e.split(""); n && (s = r.shift()); )
                                        n = n[t][s];
                                    if (!n || 0 !== r.length)
                                        return o = [],
                                        !1;
                    ...
                    d = function() {
                        ...
                        n.mixin(i.prototype, {
                            ...
                            _loadPrefetch: function() {
                                ...
                                t.resolve()) : this.prefetch.fromNetwork(r) : t.resolve(),
                                t.promise();
                                function r(e, n) {
                                    if (e)
                                        return t.reject();
                ...
                r = function(t) {
                    ...
                    s = function() {
                        ...
                        function o(n) {
                            ...
                            if (!this._callbacks)
                                return this;
                            for (n = n.split(t),
                            s = [].slice.call(arguments, 1); (i = n.shift()) && (r = this._callbacks[i]); )
                    ...
                    o = function(t) {
                        ...
                        return function(r) {
                            ...
                            (r = n.mixin({}, e, r)).node && r.pattern && (r.pattern = n.isArray(r.pattern) ? r.pattern : [r.pattern],
                        ...
                        o = {
                            initialize: function(t, o) {
                                ...
                                function p() {
                                    ...
                                    g && g.val(""),
                                    i = d(i, a),
                                    (v || _) && (p.css(a.css.wrapper),
                                    i.css(v ? a.css.input : a.css.inputWithNoHint),
                                    i.wrap(p).parent().prepend(v ? g : null).append(_ ? y : null)),
                                    A = _ ? h : c,
                                    b = new r({
                                        el: i
                                    }),
