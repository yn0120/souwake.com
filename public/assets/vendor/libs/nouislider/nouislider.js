    ...
    return function() {
        ...
        function K(r, n, i) {
            var l, p, g, v, b, S, x, y = window.navigator.pointerEnabled ? {
                ...
                return t
            }(), E = r, P = n.spectrum, V = [], A = [], k = [], U = 0, M = {}, D = !1, O = r.ownerDocument, L = n.documentElement || O.documentElement, z = O.body, H = "rtl" === O.dir || 1 === n.ort ? 0 : 100;
            function F(t, e) {
            ...
            function R(t, e) {
                ...
                i.addEventListener("keydown", (function(t) {
                    return function(t, e) {
                        ...
                        o.reverse());
                        var a, l = t.key.replace("Arrow", ""), u = l === o[0], c = l === o[1], f = l === i[0] || l === r[0] || u, p = l === i[1] || l === r[1] || c, d = l === s[0], h = l === s[1];
                        if (!(f || p || d || h))
                            return !0;
                        if (t.preventDefault(),
                        p || f) {
                        ...
                        return vt(e, P.toStepping(a), !0, !0),
                        ct("slide", e),
                        ct("update", e),
                        ct("change", e),
                        ct("set", e),
            ...
            function W(r) {
                ...
                i.forEach((function(n, s) {
                    var a, f, p, d, h, m, g, v, b, S, x = n, y = i[s + 1], w = r.mode === t.Steps;
                    for (w && (a = P.xNumSteps[s]),
                    a || (a = y - x),
                    void 0 === y && (y = x),
                    a = Math.max(a, 1e-7),
                    f = x; f <= y; f = Number((f + a).toFixed(7))) {
                        for (v = (h = (d = P.toStepping(f)) - c) / (r.density || 1),
                        S = h / (b = Math.round(v)),
                        p = 1; p <= b; p += 1)
            ...
            function $(t, r, i) {
                var o, s, a = O.createElement("div"), l = ((o = {})[e.None] = "",
                ...
                s), c = [n.cssClasses.valueHorizontal, n.cssClasses.valueVertical], f = [n.cssClasses.markerHorizontal, n.cssClasses.markerVertical];
                function p(t, e) {
                ...
                Object.keys(t).forEach((function(o) {
                    !function(t, o, s) {
                        if ((s = r ? r(o, s) : s) !== e.None) {
                            ...
                            l.style[n.style] = t + "%",
                            s > e.NoValue && ((l = F(a, !1)).className = p(s, n.cssClasses.value),
            ...
            function tt(t) {
                ...
                r ? i.top + a.y - s.clientTop : i.left + a.x - s.clientLeft)) / Q();
                return u = c(u),
                n.dir ? 100 - u : u
            }
            function et(t, e) {
            ...
            function nt(t, e) {
                ...
                0 === U && (h(E, n.cssClasses.drag),
                gt(),
                t.cursor && (z.style.cursor = "",
                z.removeEventListener("selectstart", a))),
            ...
            function it(t, e) {
                if (!e.handleNumbers.some(q)) {
                    ...
                    t.cursor && (z.style.cursor = getComputedStyle(t.target).cursor,
            ...
            function ot(t) {
                ...
                !1 !== r && (n.events.snap || u(E, n.cssClasses.tap, n.animationDuration),
                vt(r, e, !0, !0),
                gt(),
                ct("slide", r, !0),
                ct("update", r, !0),
            ...
            function lt(t, e) {
                M[t] = M[t] || [],
                M[t].push(e),
                "update" === t.split(".")[0] && g.forEach((function(t, e) {
                    ct("update", e)
                }
                ))
            }
            ...
            function ft(t, e, r, i, o, s, a) {
                var l;
                return g.length > 1 && !n.events.unconstrained && (i && e > 0 && (l = P.getAbsoluteDistance(t[e - 1], n.margin, !1),
                r = Math.max(r, l)),
                o && e < g.length - 1 && (l = P.getAbsoluteDistance(t[e + 1], n.margin, !0),
                r = Math.min(r, l))),
                g.length > 1 && n.limit && (i && e > 0 && (l = P.getAbsoluteDistance(t[e - 1], n.limit, !1),
                r = Math.min(r, l)),
                o && e < g.length - 1 && (l = P.getAbsoluteDistance(t[e + 1], n.limit, !0),
                r = Math.max(r, l))),
                n.padding && (0 === e && (l = P.getAbsoluteDistance(0, n.padding[0], !1),
                r = Math.max(r, l)),
                e === g.length - 1 && (l = P.getAbsoluteDistance(100, n.padding[1], !0),
                r = Math.min(r, l))),
                a || (r = P.getStep(r)),
                !((r = c(r)) === t[e] && !s) && r
            }
            ...
            function mt(t, e) {
                ...
                if (g[t].style[n.transformRule] = r,
            ...
            var Ct = {
                ...
                disable: function(t) {
                    null != t ? (g[t].setAttribute("disabled", ""),
                    g[t].handle.removeAttribute("tabindex")) : (E.setAttribute("disabled", ""),
                ...
                enable: function(t) {
                    null != t ? (g[t].removeAttribute("disabled"),
                    g[t].handle.setAttribute("tabindex", "0")) : (E.removeAttribute("disabled"),
                    g.forEach((function(t) {
