!function(e, t) {
    ...
    return function() {
        ...
        x.__r = 0,
        d = 0;
        var W, F, V, G = [], Q = [], Y = r.__b, q = r.__r, Z = r.diffed, X = r.__c, $ = r.unmount;
        function J() {
            for (var e; e = G.shift(); )
                if (e.__P && e.__H)
                    try {
        ...
        r.diffed = function(e) {
            Z && Z(e);
            var t = e.__c;
            t && t.__H && (t.__H.__h.length && (1 !== G.push(t) && V === r.requestAnimationFrame || ((V = r.requestAnimationFrame) || ee)(J)),
        ...
        function ce(e, t, n) {
            ...
            e.__c.__H = null),
            null != (e = re({}, e)).__c && (e.__c.__P === n && (e.__c.__P = t),
            e.__c = null),
        ...
        r.vnode = function(e) {
            ...
            if ("string" == typeof t) {
                ...
                e.props = r,
                n.class != n.className && (Re.enumerable = "className"in n,
        ...
        class Ft {
            constructor(e) {
                ...
                for (let i in e)
                    i in Ht ? (n[i] = e[i],
                    r = Math.max(Ht[i], r)) : (t[i] = e[i],
                    i in Bt && (r = Math.max(Bt[i], r)));
        ...
        function gn(e, t) {
            if (e === t)
                return !0;
            for (let n in e)
                if (ln.call(e, n) && !(n in t))
                    return !1;
            for (let n in t)
                if (ln.call(t, n) && e[n] !== t[n])
                    return !1;
            return !0
        }
        const pn = /^on[A-Z]/;
        ...
        class Sn {
            ...
            createMarkerMeta(e) {
                ...
                isNaN(e) || (t = this.timestampToMarker(e))) : Array.isArray(e) && (t = xt(e)),
                null !== t && Tt(t) ? {
                    marker: t,
                    isTimeUnspecified: !1,
                    forcedTzo: null
            ...
            countDurationsBetween(e, t, n) {
                ...
                null !== r) ? r / (ut(n) / 365) : n.months && (r = this.diffWholeMonths(e, t),
                null !== r) ? r / function(e) {
                    return ut(e) / 30
                }(n) : n.days && (r = At(e, t),
                null !== r) ? r / ut(n) : (t.valueOf() - e.valueOf()) / ht(n)
            }
            startOf(e, t) {
            ...
            formatRange(e, t, n, r={}) {
                return r.isEndExclusive && (t = bt(t, -1)),
                n.formatRange({
                    marker: e,
        ...
        function wn(e) {
            ...
            ,
            U(m(Cn, {}), document.createElement("div")); n.length; )
                n.shift()();
        ...
        class kn extends D {
            shouldComponentUpdate(e, t) {
                return this.debug,
                !mn(this.props, e, this.propEquality) || !mn(this.state, t, this.stateEquality)
            }
            safeSetState(e) {
        ...
        On.addPropsEquality({
            ...
            elAttrs: function(e, t) {
                const n = function(e, t) {
                    let n = [];
                    for (let r in e)
                        ln.call(e, r) && (r in t || n.push(r));
                    for (let r in t)
                        ln.call(t, r) && e[r] !== t[r] && n.push(r);
                    return n
                }(e, t);
                for (let e of n)
                    if (!pn.test(e))
        ...
        class Jn {
            ...
            buildRangeFromDuration(e, t, n, r) {
                ...
                return ut(n) <= 1 && this.isHiddenDay(i) && (i = this.skipHiddenDays(i, t),
                i = St(i)),
                c(),
        ...
        function Rr(e, t, n) {
            let {defs: r} = e
              , i = un(e.instances, (e => r[e.defId].allDay ? e : Object.assign(Object.assign({}, e), {
                range: {
        ...
        function kr(e, t) {
            return cr(function(e) {
                ...
                return t = t.map((e => Object.assign(Object.assign({}, Tr), e))),
                t
            }(e), null, t)
        }
        function Mr(e, t, n) {
        ...
        class ci extends Mn {
            ...
            render() {
                ...
                return li() || s.push("fc-liquid-hack"),
                e.children(s, i, r, n)
            }
            componentDidMount() {
        ...
        function Ti(e, t=!1, n) {
            let r = n ? e.getBoundingClientRect() : ki(e)
              , i = function(e, t=!1) {
                ...
                return Ri() && "rtl" === n.direction ? c.scrollbarLeft = l : c.scrollbarRight = l,
        ...
        class ji {
            ...
            insertEntryAt(e, t) {
                ...
                -1 === t.lateral ? (Wi(r, t.level, t.levelCoord),
                Wi(n, t.level, [e])) : Wi(n[t.level], t.lateral, e),
            ...
            findInsertion(e) {
                ...
                for (let u = 0; u < s; u += 1) {
                    ...
                    if (!r && s >= o + this.getEntryThickness(e))
                        break;
                    let h, f = n[u], g = Fi(f, e.span.start, zi), p = g[0] + g[1];
        ...
        class Ki extends Mn {
            constructor() {
                super(...arguments),
                this.createDayHeaderFormatter = Nt(es)
            }
            render() {
                let {context: e} = this
            ...
            return !(e.eventDrag && !function(e, t, n, r) {
                ...
                for (let r in l) {
                    let o = l[r]
                      ...
                      , p = c[o.defId]
                      , m = a[o.defId];
                    if (!ls(p.constraints, g, d, e.businessHours, t))
                        return !1;
                    ...
                    for (let e of p.allows) {
                        ...
                        if (i = a ? new jr(t,a,l) : new jr(t,m),
                        !e(Ir(s, t), i))
                            return !1
                    }
                }
                ...
                r && (c = r(c));
                if (!ls(c.constraints, l, i, e.businessHours, t))
                    return !1;
                ...
                for (let e in o) {
                    ...
                    if (Gn(l, n.range)) {
                        if (!1 === c.overlap)
                            return !1;
                        if (u && !u(new jr(t,s[n.defId],n), null))
                            return !1
                    }
                }
        ...
        function Ws(e) {
            ...
            return {
                ...
                n.reduce(Gs).eventRange.range.end)
            };
            var n
        }
        function Fs(e) {
        ...
        function ko(e, t, n) {
            ...
            n.formatRange(r.start, r.end, Zt(t.titleFormat || function(e) {
        ...
        class Mo {
            ...
            processRawCalendarOptions(e, t) {
                let {locales: n, locale: r} = sn([$t, e, t])
                  ...
                  , l = this.currentCalendarOptionsRefiners = Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({}, Xt), Jt), Kt), a.listenerRefiners), a.optionRefiners)
                  , c = {}
                  , d = sn([$t, o, e, t])
                  , u = {}
                  ...
                  , g = !1;
                for (let e in d)
                    -1 === this.optionsForRefining.indexOf(e) && (d[e] === h[e] || en[e] && e in h && en[e](h[e], d[e])) ? u[e] = f[e] : l[e] ? (u[e] = l[e](d[e]),
                    g = !0) : c[e] = h[e];
            ...
            processRawViewOptions(e, t, n, r, i) {
                let s = sn([$t, e.optionDefaults, n, r, e.optionOverrides, i])
                  ...
                  , u = {};
                for (let e in s)
                    s[e] === l[e] || en[e] && en[e](s[e], l[e]) ? a[e] = c[e] : (s[e] === this.currentCalendarOptionsInput[e] || en[e] && en[e](s[e], this.currentCalendarOptionsInput[e]) ? e in this.currentCalendarOptionsRefined && (a[e] = this.currentCalendarOptionsRefined[e]) : o[e] ? a[e] = o[e](s[e]) : u[e] = s[e],
                    d = !0);
        ...
        class Yo extends kn {
            ...
            render() {
                let e, {props: t} = this, {toolbarConfig: n, options: r} = t, i = this.buildToolbarProps(t.viewSpec, t.dateProfile, t.dateProfileGenerator, t.currentDate, $n(t.options.now, t.dateEnv), t.viewTitle), s = !1, o = "";
        ...
        class ma extends Bi {
            ...
            render() {
                let {props: e, state: t, context: n} = this
                  ...
                  , {singleColPlacements: c, multiColPlacements: d, moreCnts: u, moreMarginTops: h} = fa(Qr(e.fgEventSegs, r.eventOrder), e.dayMaxEvents, e.dayMaxEventRows, r.eventOrderStrict, t.segHeights, t.maxContentHeight, e.cells)
        ...
        class va extends Bi {
            ...
            prepareHits() {
                this.rowPositions = new Ii(this.rootEl,this.rowRefs.collect().map((e => e.getCellEls()[0])),!1,!0),
            ...
            flushScrollReset() {
                if (this.needsScrollReset && this.props.clientWidth) {
                    const e = function(e, t) {
                        let n;
                        t.currentRangeUnit.match(/year|month/) && (n = e.querySelector(`[data-date="${r = t.currentDate,
                    ...
                    dateProfileGeneratorClass: class extends Jn {
                        buildRenderRange(e, t, n) {
                            ...
                            return function(e) {
                                ...
                                e.snapToWeek && (i = n.startOfWeek(i),
                                t = n.startOfWeek(s),
        ...
        class _a {
            constructor(e) {
                ...
                Ca += 1,
                1 === Ca && window.addEventListener("touchmove", xa, {
                    passive: !1
                })
            }
            destroy() {
                ...
                Ca -= 1,
                Ca || window.removeEventListener("touchmove", xa, {
                    passive: !1
                })
            }
            tryStart(e) {
                let t = this.querySubjectEl(e)
                  , n = e.target;
                return !(!t || this.handleSelector && !Be(n, this.handleSelector)) && (this.subjectEl = t,
                this.isDragging = !0,
                this.wasTouchScroll = !1,
                !0)
            }
        ...
        class Ta {
            ...
            cleanup() {
                this.mirrorEl && (He(this.mirrorEl),
                this.mirrorEl = null),
                this.sourceEl = null
            }
            updateElPosition() {
        ...
        class Ha {
            ...
            isWithinClipping(e, t) {
                ...
                for (let e of this.scrollCaches)
                    if (!Ba(e.getEventTarget()) && !gi(n, e.clientRect))
                        return !1;
                return !0
            }
        }
        ...
        class ja {
            ...
            processFirstCoord(e) {
                ...
                var s, o;
                i instanceof HTMLElement && (t = ki(i),
                s = r,
                o = t,
                r = {
            ...
            handleMove(e, t) {
                ...
                !t && za(this.movingHit, n) || (this.movingHit = n,
                this.emitter.trigger("hitupdate", n, !1, e))
            }
            prepareHits() {
                this.offsetTrackers = un(this.droppableStore, (e => (e.component.prepareHits(),
                new Ha(e.el))))
            }
            releaseHits() {
                ...
                for (let s in n) {
                    ...
                    if (a && a.isWithinClipping(e, t)) {
                        ...
                        if (l >= 0 && l < u && c >= 0 && c < h) {
                            ...
                            e && Qn(e.dateProfile.activeRange, e.dateSpan.range) && (this.disablePointCheck || a.el.contains(a.el.getRootNode().elementFromPoint(l + n - window.scrollX, c + r - window.scrollY))) && (!i || e.layer > i.layer) && (e.componentId = s,
                            e.context = o.context,
                            e.rect.left += n,
                            e.rect.right += n,
                            e.rect.top += r,
            ...
            constructor(e) {
                ...
                this.handleHitUpdate = (e, t) => {
                    ...
                    if (e) {
                        ...
                        o && (a = Nr(n, s.getCurrentData().eventUiBases, o, s),
                        c.mutatedEvents = a,
                        ss(c, e.dateProfile, s) || (l = !0,
                        o = null,
                        a = null,
                        c.mutatedEvents = {
                            defs: {},
        ...
        var Va = Js({
            ...
            , class extends di {
                constructor(e) {
                    ...
                    ,
                    this.handlePointerUp = e => {
                        this.dragSelection && (Mr(this.dragSelection, e, this.component.context),
                        this.dragSelection = null)
                    }
                    ;
                    let {component: t} = e
            ...
            , La, class extends di {
                constructor(e) {
                    ...
                    this.handleHitUpdate = (e, t, n) => {
                        ...
                        a && (l = Nr(i, r.getCurrentData().eventUiBases, a, r),
                        d.mutatedEvents = l,
                        ss(d, e.dateProfile, r) || (c = !0,
                        a = null,
                        l = null,
            ...
            render() {
                ...
                return m(Cs, Object.assign({}, e, {
                    ...
                    if (!1 !== s.displayEventTime) {
                        ...
                        }(e.eventRange.range) ? o = $r(e, t, n) : e.isStart ? o = $r(e, t, n, null, null, l.range.start, e.end) : e.isEnd ? o = $r(e, t, n, null, null, e.start, l.range.end) : c = !0,
                        c) {
                            let e = {
        ...
        function nl(e) {
            ...
            return m(xn.Consumer, null, (n => {
                ...
                let {dateEnv: r, options: i, viewApi: s} = n
                  , o = null == i.slotLabelFormat ? tl : Array.isArray(i.slotLabelFormat) ? Zt(i.slotLabelFormat[0]) : Zt(i.slotLabelFormat)
                  , a = {
                    level: 0,
                    time: e.time,
        ...
        class ll {
            ...
            computeTimeTop(e) {
                let t, n, {positions: r, dateProfile: i} = this, s = r.els.length, o = (e.milliseconds - ht(i.slotMinTime)) / ht(this.slotDuration);
        ...
        class dl extends Mn {
            ...
            updateSizing() {
                ...
                if (t.onCoords && null !== t.clientWidth) {
                    this.rootElRef.current.offsetHeight && t.onCoords(new ll(new Ii(this.rootElRef.current,(n = this.slatElRefs.currentMap,
                  ...
                  , n = bl(( (e, t) => e + ":" + t), ( (r, i) => {
                    let s = function(e, t, n) {
                        ...
                        for (; l < a && r[l] < o; l += 1)
                            ;
                        for (; l < a; l += 1) {
                            let e, t = i[l], n = Fi(t, s.span.start, zi), r = n[0] + n[1], o = r;
        ...
        class Rl extends Mn {
            ...
            updateCoords() {
                let {props: e} = this;
                var t;
                e.onColCoords && null !== e.clientWidth && e.onColCoords(new Ii(this.rootElRef.current,(t = this.cellElRefs.currentMap,
        ...
        function Ol(e, t, n, r, i) {
            ...
            for (; ht(o) < ht(t); ) {
                ...
                c.push({
                    ...
                    key: e.toISOString(),
                    isoTimeStr: (d = e,
                    tt(d.getUTCHours(), 2) + ":" + tt(d.getUTCMinutes(), 2) + ":" + tt(d.getUTCSeconds(), 2)),
                    isLabeled: t
                }),
                o = dt(o, r),
                a = dt(a, r)
                    ...
                    component: class extends ol {
                        ...
                        render() {
                            let {options: e, dateEnv: t, dateProfileGenerator: n} = this.context
                              ...
                              , f = t => m(kl, Object.assign({}, o.timed, {
                                dayTableModel: s,
                                dateProfile: i,
                                axis: c,
                                slotDuration: e.slotDuration,
