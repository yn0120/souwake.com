!function(t, e) {
    ...
    return function() {
        var t = {
            6729: function(t) {
                ...
                l.prototype.emit = function(t, e, r, s, i, o) {
                    ...
                    if (u.fn) {
                        ...
                        case 3:
                            ...
                            !0;
                        case 4:
                            return u.fn.call(u.context, e, r, s),
                            !0;
                        case 5:
                            return u.fn.call(u.context, e, r, s, i),
                            !0;
                        case 6:
                            return u.fn.call(u.context, e, r, s, i, o),
                            !0
                        }
                        for (c = 1,
                ...
                l.prototype.removeListener = function(t, e, r, s) {
                    ...
                    if (l.fn)
                        l.fn !== e || s && !l.once || r && l.context !== r || o(this, i);
                    else {
            ...
            7529: function(t) {
                ...
                function n(t, f, p, g, m) {
                    ...
                    var N = t.substring(t.length - y)
                      , E = function(t, i) {
                        ...
                        var a = t.length > i.length ? t : i
                          ...
                          , u = a.indexOf(c);
                        if (-1 !== u)
                            return l = [[1, a.substring(0, u)], [0, c], [1, a.substring(u + c.length)]],
                        ...
                        var h = function(t, e) {
                            ...
                            if (n.length < 4 || 2 * r.length < n.length)
                                return null;
                            function i(t, e, n) {
                                for (var r, i, l, a, c = t.substring(n, n + Math.floor(t.length / 4)), u = -1, h = ""; -1 !== (u = e.indexOf(c, u + 1)); ) {
                            ...
                            var l, a, c, u, h, d = i(n, r, Math.ceil(n.length / 4)), f = i(n, r, Math.ceil(n.length / 2));
                            if (!d && !f)
                                return null;
                            l = f ? d && d[4].length > f[4].length ? d : f : d;
                            t.length > e.length ? (a = l[0],
                            c = l[1],
                            u = l[2],
                            h = l[3]) : (u = l[0],
                            h = l[1],
                        ...
                        return function(t, n) {
                            for (var s = t.length, i = n.length, o = Math.ceil((s + i) / 2), l = o, a = 2 * o, c = new Array(a), u = new Array(a), h = 0; h < a; h++)
                                c[h] = -1,
                                u[h] = -1;
                            c[l + 1] = 0,
                            u[l + 1] = 0;
                            for (var d = s - i, f = d % 2 != 0, p = 0, g = 0, m = 0, b = 0, v = 0; v < o; v++) {
                                for (var y = -v + p; y <= v - g; y += 2) {
                                    for (var x = l + y, N = (k = y === -v || y !== v && c[x - 1] < c[x + 1] ? c[x + 1] : c[x - 1] + 1) - y; k < s && N < i && t.charAt(k) === n.charAt(N); )
                                        k++,
                                        N++;
                                    if (c[x] = k,
                                    k > s)
                                ...
                                for (var E = -v + m; E <= v - b; E += 2) {
                                    for (var w, A = l + E, q = (w = E === -v || E !== v && u[A - 1] < u[A + 1] ? u[A + 1] : u[A - 1] + 1) - E; w < s && q < i && t.charAt(s - w - 1) === n.charAt(i - q - 1); )
                                        w++,
                                        q++;
                                    if (u[A] = w,
                                    w > s)
                    ...
                    g && function(t) {
                        ...
                        for (; p < t.length; )
                            ...
                            b = 0,
                            v = 0,
                            f = t[p][1]) : (1 == t[p][0] ? b += t[p][1].length : v += t[p][1].length,
                            f && f.length <= Math.max(g, m) && f.length <= Math.max(b, v) && (t.splice(r[s - 1], 0, [e, f]),
                            t[r[s - 1] + 1][0] = 1,
                            s--,
                            p = --s > 0 ? r[s - 1] : -1,
                            g = 0,
                        ...
                        (function(t) {
                            ...
                            for (; n < t.length - 1; ) {
                                if (0 == t[n - 1][0] && 0 == t[n + 1][0]) {
                                    ...
                                    t[n - 1][1] != p && (p ? t[n - 1][1] = p : (t.splice(n - 1, 1),
                                    n--),
                                    t[n][1] = g,
                                    m ? t[n + 1][1] = m : (t.splice(n + 1, 1),
                                    n--))
                                }
                                n++
                            }
                        ...
                        for (; p < t.length; ) {
                            if (t[p - 1][0] == e && 1 == t[p][0]) {
                                var y = t[p - 1][1]
                                  ...
                                  , N = i(y, x)
                                  , E = i(x, y);
                                N >= E ? (N >= y.length / 2 || N >= x.length / 2) && (t.splice(p, 0, [0, x.substring(0, N)]),
                                t[p - 1][1] = y.substring(0, y.length - N),
                                t[p + 1][1] = x.substring(N),
                                p++) : (E >= y.length / 2 || E >= x.length / 2) && (t.splice(p, 0, [0, y.substring(0, E)]),
                                t[p - 1][0] = 1,
                ...
                function i(t, e) {
                    ...
                    for (var i = 0, o = 1; ; ) {
                        ...
                        if (-1 == a)
                            return i;
                        o += a,
                        0 != a && t.substring(s - o) != e.substring(0, o) || (i = o,
                        o++)
                    }
                }
                function o(t, e) {
                    ...
                    for (var n = 0, r = Math.min(t.length, e.length), s = r, i = 0; n < s; )
                        ...
                        s = Math.floor((r - n) / 2 + n);
                    return p(t.charCodeAt(t.length - s)) && s--,
                    s
                }
                var l = /[^a-zA-Z0-9]/
                  , a = /\s/
                ...
                function d(t, n) {
                        ...
                        if (i < t.length - 1 && !t[i][1])
                            ...
                            case 0:
                                ...
                                if (c.length > 0 || u.length > 0) {
                                    c.length > 0 && u.length > 0 && (0 !== (r = s(u, c)) && (h >= 0 ? t[h][1] += u.substring(0, r) : (t.splice(0, 0, [0, u.substring(0, r)]),
                                    i++),
                                    u = u.substring(r),
                                    c = c.substring(r)),
                                    0 !== (r = o(u, c)) && (t[i][1] = u.substring(u.length - r) + t[i][1],
                                    u = u.substring(0, u.length - r),
                                    c = c.substring(0, c.length - r)));
                                    var b = a + l;
                                    0 === c.length && 0 === u.length ? (t.splice(i - b, b),
                                    i -= b) : 0 === c.length ? (t.splice(i - b, b, [1, u]),
                                    i = i - b + 1) : 0 === u.length ? (t.splice(i - b, b, [e, c]),
                                    i = i - b + 1) : (t.splice(i - b, b, [e, c], [1, u]),
                                    i = i - b + 2)
                                }
                                0 !== i && 0 === t[i - 1][0] ? (t[i - 1][1] += t[i][1],
                                t.splice(i, 1)) : i++,
                                a = 0,
                                l = 0,
                                c = "",
                    ...
                    for (i = 1; i < t.length - 1; )
                        0 === t[i - 1][0] && 0 === t[i + 1][0] && (t[i][1].substring(t[i][1].length - t[i - 1][1].length) === t[i - 1][1] ? (t[i][1] = t[i - 1][1] + t[i][1].substring(0, t[i][1].length - t[i - 1][1].length),
                        t[i + 1][1] = t[i - 1][1] + t[i + 1][1],
                        t.splice(i - 1, 1),
                        v = !0) : t[i][1].substring(0, t[i + 1][1].length) == t[i + 1][1] && (t[i - 1][1] += t[i + 1][1],
            ...
            3465: function(t, e, n) {
                ...
                var r = "__lodash_hash_undefined__"
                  ...
                  , j = /^(?:0|[1-9]\d*)$/
                  , C = {};
                C[i] = C["[object Array]"] = C[y] = C[x] = C[o] = C[l] = C[N] = C[E] = C[w] = C[A] = C[q] = C[u] = C[h] = C[d] = C[p] = C[g] = C[m] = C[b] = C[k] = C[_] = C[L] = C[O] = !0,
                ...
                function St(t, e) {
                    var n = Vt(t) || function(t) {
                        ...
                        }(t) && tt.call(t, "callee") && (!at.call(t, "callee") || et.call(t) == i)
                    }(t) ? function(t, e) {
                      ...
                      , s = !!r;
                    for (var o in t)
                        !e && !tt.call(t, o) || s && ("length" == o || zt(o, r)) || n.push(o);
                    return n
                }
                function Tt(t, e, n) {
                    var r = t[e];
                    ...
                    if (j) {
                        ...
                        if (R == d || R == i || I && !f) {
                            if (H(t))
                                return f ? t : {};
                            if (T = function(t) {
                                return "function" != typeof t.constructor || Ft(t) ? {} : (e = ot(t),
                                Gt(e) ? lt(e) : {});
                                var e
                            }(I ? {} : t),
                            !e)
                ...
                function Rt(t) {
                    return !(!Gt(t) || (e = t,
                    Q && Q in e)) && (Zt(t) || H(t) ? nt : T).test(Ht(t));
                    var e
                }
                function It(t) {
                ...
                function Bt(t, e) {
                    var n, r, s = t.__data__;
                    return ("string" == (r = typeof (n = e)) || "number" == r || "symbol" == r || "boolean" == r ? "__proto__" !== n : null === n) ? s["string" == typeof e ? "string" : "hash"] : s.map
                }
                function Dt(t, e) {
                    var n = function(t, e) {
                ...
                kt.prototype.set = function(t, e) {
                    return this.__data__[t] = vt && void 0 === e ? r : e,
                    this
                }
                ,
                ...
                ;
                var Ut = ut ? V(ut, Object) : function() {
                    return []
                }
                  , Pt = function(t) {
                    return et.call(t)
                ...
                (ft && Pt(new ft(new ArrayBuffer(1))) != x || pt && Pt(new pt) != u || gt && Pt(gt.resolve()) != f || mt && Pt(new mt) != g || bt && Pt(new bt) != v) && (Pt = function(t) {
                    var e = et.call(t)
            ...
            2307: function(t, e, n) {
                ...
                var B, D, U, P = Array.prototype, z = Function.prototype, F = Object.prototype, H = _["__core-js_shared__"], $ = z.toString, V = F.hasOwnProperty, K = (B = /[^.]+$/.exec(H && H.keys && H.keys.IE_PROTO || "")) ? "Symbol(src)_1." + B : "", W = F.toString, Z = RegExp("^" + $.call(V).replace(/[\\^$.*+?()[\]{}|]/g, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"), G = S ? _.Buffer : void 0, X = _.Symbol, Y = _.Uint8Array, Q = F.propertyIsEnumerable, J = P.splice, tt = X ? X.toStringTag : void 0, et = Object.getOwnPropertySymbols, nt = G ? G.isBuffer : void 0, rt = (D = Object.keys,
                U = Object,
                function(t) {
                    return D(U(t))
                }
                ), st = jt(_, "DataView"), it = jt(_, "Map"), ot = jt(_, "Promise"), lt = jt(_, "Set"), at = jt(_, "WeakMap"), ct = jt(Object, "create"), ut = Mt(st), ht = Mt(it), dt = Mt(ot), ft = Mt(lt), pt = Mt(at), gt = X ? X.prototype : void 0, mt = gt ? gt.valueOf : void 0;
                function bt(t) {
                    var e = -1
                      , n = null == t ? 0 : t.length;
                    for (this.clear(); ++e < n; ) {
                ...
                function Et(t, e) {
                    var n = Ut(t)
                      ...
                      , a = l.length;
                    for (var c in t)
                        !e && !V.call(t, c) || o && ("length" == c || s && ("offset" == c || "parent" == c) || i && ("buffer" == c || "byteLength" == c || "byteOffset" == c) || It(c, a)) || l.push(c);
                    return l
                }
                function wt(t, e) {
                    for (var n = t.length; n--; )
                ...
                function kt(t, e, n, r, s) {
                    return t === e || (null == t || null == e || !$t(t) && !$t(e) ? t != t && e != e : function(t, e, n, r, s, u) {
                        var p = Ut(t)
                          , y = Ut(e)
                          , E = p ? o : Rt(t)
                          , w = y ? o : Rt(e)
                        ...
                        if (k && !A)
                            return u || (u = new Nt),
                            p || Vt(t) ? Ot(t, e, n, r, s, u) : function(t, e, n, r, s, i, o) {
                                switch (n) {
                                case N:
                        ...
                        function(t, e, n, r, s, i) {
                            ...
                            for (; ++h < a; ) {
                                var m = t[d = l[h]]
                                  , b = e[d];
                                if (r)
                                    var v = o ? r(b, m, d, e, t, i) : r(m, b, d, t, e, i);
                ...
                function Ot(t, e, n, r, s, i) {
                    ...
                    i.set(e, t); ++u < l; ) {
                        var f = t[u]
                          , p = e[u];
                        if (r)
                            var g = o ? r(p, f, u, e, t, i) : r(f, p, u, t, e, i);
                        if (void 0 !== g) {
                            if (g)
                                continue;
                            h = !1;
                ...
                vt.prototype.delete = function(t) {
                    var e = this.__data__
                      , n = wt(e, t);
                    return !(n < 0) && (n == e.length - 1 ? e.pop() : J.call(e, n, 1),
                    --this.size,
                    !0)
                }
                ,
                ...
                (st && Rt(new st(new ArrayBuffer(1))) != N || it && Rt(new it) != h || ot && Rt(ot.resolve()) != p || lt && Rt(new lt) != m || at && Rt(new at) != y) && (Rt = function(t) {
                    var e = At(t)
            ...
            1210: function(t, e, n) {
                ...
                !function(t) {
                    t.compose = function(t={}, e={}, n=!1) {
                        ...
                        "object" != typeof e && (e = {});
                        let s = r(e);
                        n || (s = Object.keys(s).reduce(( (t, e) => (null != s[e] && (t[e] = s[e]),
                        t)), {}));
                        for (const n in t)
                    ...
                    t.diff = function(t={}, e={}) {
                        "object" != typeof t && (t = {}),
                        "object" != typeof e && (e = {});
                        const n = Object.keys(t).concat(Object.keys(e)).reduce(( (n, r) => (s(t[r], e[r]) || (n[r] = void 0 === e[r] ? null : e[r]),
                        n)), {});
                        ...
                        for (; e.hasNext() || n.hasNext(); )
                            if ("insert" === n.peekType())
                                ...
                                if (s.retain) {
                                    ...
                                    "number" == typeof s.delete && ("number" == typeof r.retain || "object" == typeof r.retain && null !== r.retain) && l.push(s)
                            }
                        return l.chop()
                    }
                    concat(t) {
                        ...
                        return l.forEach((t => {
                            ...
                            for (; e > 0; ) {
                                ...
                                case r.EQUAL:
                                    ...
                                    const t = u.next(n)
                                      , l = d.next(n);
                                    i(t.insert, l.insert) ? s.retain(n, o.default.diff(t.attributes, l.attributes)) : s.push(l).delete(n)
                                }
                                e -= n
                            }
                        }
                    ...
                    eachLine(t, e="\n") {
                        ...
                        for (; n.hasNext(); ) {
                            ...
                            if (a < 0)
                                ...
                                if (!1 === t(r, n.next(1).attributes || {}, s))
                                    return;
                                s += 1,
                                r = new h
                            }
                    ...
                    transform(t, e=!1) {
                        ...
                        for (; r.hasNext() || s.hasNext(); )
                            if ("insert" !== r.peekType() || !e && "insert" === s.peekType())
                                ...
                                i.retain(l.default.length(r.next()));
                        return i.chop()
                    }
                    transformPosition(t, e=!1) {
                        ...
                        for (; n.hasNext() && r <= t; ) {
                            const s = n.peekLength()
                              , i = n.peekType();
                            n.next(),
                            "delete" !== i ? ("insert" === i && (r < t || !e) && (t += s),
                            r += s) : t -= Math.min(s, t - r)
                        }
                        return t
                    }
                }
        ...
        return function() {
            ...
            }, C = y["__core-js_shared__"], R = (T = /[^.]+$/.exec(C && C.keys && C.keys.IE_PROTO || "")) ? "Symbol(src)_1." + T : "";
            var I = function(t) {
                return !!R && R in t
            }
            ...
            var B = function(t) {
              ...
              , z = U.toString
              , F = P.hasOwnProperty
              , H = RegExp("^" + z.call(F).replace(/[\\^$.*+?()[\]{}|]/g, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$");
            var $ = function(t) {
            ...
            var re = function(t) {
              ...
              , se = {};
            se["[object Float32Array]"] = se["[object Float64Array]"] = se["[object Int8Array]"] = se["[object Int16Array]"] = se["[object Int32Array]"] = se["[object Uint8Array]"] = se["[object Uint8ClampedArray]"] = se["[object Uint16Array]"] = se["[object Uint32Array]"] = !0,
            se["[object Arguments]"] = se["[object Array]"] = se["[object ArrayBuffer]"] = se["[object Boolean]"] = se["[object DataView]"] = se["[object Date]"] = se["[object Error]"] = se["[object Function]"] = se["[object Map]"] = se["[object Number]"] = se["[object Object]"] = se["[object RegExp]"] = se["[object Set]"] = se["[object String]"] = se["[object WeakMap]"] = !1;
            var ie = function(t) {
            ...
            var Ne = function(t, e) {
                var n = Ht(t)
                  ...
                  , a = l.length;
                for (var c in t)
                    !e && !xe.call(t, c) || o && ("length" == c || s && ("offset" == c || "parent" == c) || i && ("buffer" == c || "byteLength" == c || "byteOffset" == c) || ye(c, a)) || l.push(c);
                return l
            };
            var Ee = function(t) {
                var e = [];
                ...
                if (c)
                    ...
                    if (h) {
                        var d = Ht(a)
                          ...
                          , p = !d && !f && de(a);
                        u = a,
                        d || f || p ? Ht(l) ? u = l : Kt(l) ? u = Lt(l) : f ? (h = !1,
                        u = At(a, !0)) : p ? (h = !1,
                        u = _t(a, !0)) : u = [] : re(a) || Ft(a) ? (u = l,
                        Ft(l) ? u = ke(l) : S(l) && !j(l) || (u = It(a))) : h = !1
                    }
                    h && (o.set(a, u),
                    s(u, a, r, i, o),
                    o.delete(a)),
            ...
            var je = function(t, e, n) {
                return e = Te(void 0 === e ? t.length - 1 : e, 0),
                function() {
                    for (var r = arguments, s = -1, i = Te(r.length - e, 0), o = Array(i); ++s < i; )
                        o[s] = r[e + s];
                    s = -1;
            ...
            var Pe = function(t) {
                return De((function(e, n) {
                    var r = -1
                      ...
                      , i = s > 1 ? n[s - 1] : void 0
                      , o = s > 2 ? n[2] : void 0;
                    for (i = t.length > 3 && "function" == typeof i ? (s--,
                    i) : void 0,
                    o && Ue(n[0], n[1], o) && (i = s < 3 ? void 0 : i,
                    s = 1),
                    e = Object(e); ++r < s; ) {
                        var l = n[r];
                        l && t(e, l, r, i)
            ...
            const $e = class t {
                ...
                create(e, n, r) {
                    ...
                    if (null == s)
                        throw new He(`Unable to create ${n} blot`);
                    const i = s
                      , o = n instanceof Node || n.nodeType === Node.TEXT_NODE ? n : i.create(r)
                      , l = new i(e,o,r);
                    return t.blots.set(l.domNode, l),
                    l
                }
                find(e, n=!1) {
                    return t.find(e, n)
                ...
                query(t, e=ze.ANY) {
                    let n;
                    return "string" == typeof t ? n = this.types[t] || this.attributes[t] : t instanceof Text || t.nodeType === Node.TEXT_NODE ? n = this.types.text : "number" == typeof t ? t & ze.LEVEL & ze.BLOCK ? n = this.types.block : t & ze.LEVEL & ze.INLINE && (n = this.types.inline) : t instanceof Element && ((t.getAttribute("class") || "").split(/\s+/).some((t => (n = this.classes[t],
                    !!n))),
            ...
            const Ge = class extends Fe {
                ...
                add(t, e) {
                    return !!this.canAdd(t, e) && (t.style[Ze(this.keyName)] = e,
                    !0)
                }
                remove(t) {
            ...
            const Xe = class {
              ...
              , Ye = class {
                ...
                formatAt(t, e, n, r) {
                    ...
                    if (null != this.scroll.query(n, ze.BLOT) && r)
                        s.wrap(n, r);
            ...
            class en {
                ...
                find(t, e=!1) {
                    ...
                    for (; r; ) {
                        const s = r.length();
                        if (t < s || e && t === s && (null == r.next || 0 !== r.next.length()))
                            return [r, t];
                        t -= s,
                        r = n()
                    }
                ...
                forEachAt(t, e, n) {
                    ...
                    for (; l && i < t + e; ) {
                        const r = l.length();
                        t > i ? n(l, t - i, Math.min(e, i + r - t)) : n(l, 0, Math.min(r, t + e - i)),
                        i += r,
                        l = o()
                    }
                }
            ...
            const rn = class t extends Qe {
                ...
                descendant(e, n=0) {
                    ...
                    return null == e.blotName && e(r) || null != e.blotName && r instanceof e ? [r, s] : r instanceof t ? r.descendant(e, s) : [null, -1]
                }
                ...
                enforceAllowedChildren() {
                    ...
                    this.children.forEach((n => {
                        e || this.statics.allowedChildren.some((t => n instanceof t)) || (n.statics.scope === ze.BLOCK_BLOT ? (null != n.next && this.splitAfter(n),
                ...
                path(e, n=!1) {
                    const [r,s] = this.children.find(e, n)
                      , i = [[this, e]];
                    return r instanceof t ? i.concat(r.path(s, n)) : (null != r && i.push([r, s]),
                    i)
                }
                removeChild(t) {
            ...
            const on = class t extends sn {
                ...
                constructor(t, e) {
                    super(t, e),
                    this.attributes = new Xe(this.domNode)
                }
                format(e, n) {
                    if (e !== this.statics.blotName || n) {
                        ...
                        if (null == t)
                            return;
                        t instanceof Fe ? this.attributes.attribute(t, n) : n && (e !== this.statics.blotName || this.formats()[e] !== n) && this.replaceWith(e, n)
                    } else
                ...
                formatAt(t, e, n, r) {
                    null != this.formats()[n] || this.scroll.query(n, ze.ATTRIBUTE) ? this.isolate(t, e).format(n, r) : super.formatAt(t, e, n, r)
                }
                optimize(e) {
                    super.optimize(e);
            ...
            const ln = on
              , an = class t extends sn {
                ...
                format(e, n) {
                    ...
                    null != r && (r instanceof Fe ? this.attributes.attribute(r, n) : e !== this.statics.blotName || n ? n && (e !== this.statics.blotName || this.formats()[e] !== n) && this.replaceWith(e, n) : this.replaceWith(t.blotName))
                }
                formats() {
                    const t = this.attributes.values()
                      , e = this.statics.formats(this.domNode, this.scroll);
            ...
            ;
            un.blotName = "container",
            un.scope = ze.BLOCK_BLOT;
            const hn = un;
              ...
              , pn = class extends sn {
                ...
                optimize(t=[], e={}) {
                    ...
                    const s = (t, e=!0) => {
                      ...
                      , i = t => {
                        n.has(t.domNode) && (t instanceof sn && t.children.forEach(i),
                        n.delete(t.domNode),
                        t.optimize(e))
                    }
                    ;
                    ...
                    for (let e = 0; o.length > 0; e += 1) {
                        ...
                        for (o.forEach((t => {
                            ...
                            Array.from(t.addedNodes).forEach((t => {
                                ...
                                s(e, !1),
                                e instanceof sn && e.children.forEach((t => {
                                    s(t, !1)
                                }
                                ))
                            }
            ...
            var jn = function(t, e) {
              ...
              , Cn = Object.getOwnPropertySymbols ? function(t) {
                for (var e = []; t; )
                    jn(e, Sn(t)),
                    t = jt(t);
                return e
            ...
            var Bn = function(t) {
              ...
              , Yn = B(zn)
              , Qn = O;
            (Dn && Qn(new Dn(new ArrayBuffer(1))) != Kn || W && Qn(new W) != Fn || Un && Qn(Un.resolve()) != Hn || Pn && Qn(new Pn) != $n || zn && Qn(new zn) != Vn) && (Qn = function(t) {
                var e = O(t)
            ...
            var dr = function(t) {
              ...
              , br = "[object Object]"
              , vr = {};
            vr[gr] = vr["[object Array]"] = vr["[object ArrayBuffer]"] = vr["[object DataView]"] = vr["[object Boolean]"] = vr["[object Date]"] = vr["[object Float32Array]"] = vr["[object Float64Array]"] = vr["[object Int8Array]"] = vr["[object Int16Array]"] = vr["[object Int32Array]"] = vr["[object Map]"] = vr["[object Number]"] = vr[br] = vr["[object RegExp]"] = vr["[object Set]"] = vr["[object String]"] = vr["[object Symbol]"] = vr["[object Uint8Array]"] = vr["[object Uint8ClampedArray]"] = vr["[object Uint16Array]"] = vr["[object Uint32Array]"] = !0,
            vr["[object Error]"] = vr[mr] = vr["[object WeakMap]"] = !1;
            var yr = function t(e, n, r, s, i, o) {
                var l, a = 1 & n, c = 2 & n, u = 4 & n;
                if (r && (l = i ? r(e, s, i, o) : r(e)),
                void 0 !== l)
                    return l;
                if (!S(e))
                    return e;
                ...
                if (p)
                    return p;
                o.set(e, l),
                pr(e) ? e.forEach((function(s) {
                    l.add(t(s, n, r, s, e, o))
                }
                )) : hr(e) && e.forEach((function(s, i) {
                    l.set(i, t(s, n, r, i, e, o))
                }
                ));
                var g = h ? void 0 : (u ? c ? Bn : Mn : c ? qe : wn)(e);
                return yn(g || e, (function(s, i) {
                    g && (s = e[i = s]),
                    ge(l, i, t(s, n, r, i, e, o))
                }
                )),
                l
            };
            ...
            wr.prototype.add = wr.prototype.push = Nr,
            wr.prototype.has = Er;
            var Ar = wr;
            var qr = function(t, e) {
                for (var n = -1, r = null == t ? 0 : t.length; ++n < r; )
            ...
            var _r = function(t, e, n, r, s, i) {
                ...
                i.set(e, t); ++h < l; ) {
                    var p = t[h]
                      , g = e[h];
                    if (r)
                        var m = o ? r(g, p, h, e, t, i) : r(p, g, h, t, e, i);
                    if (void 0 !== m) {
                        if (m)
                            continue;
                        d = !1;
            ...
            var Rr = function(t, e, n, r, s, i) {
                ...
                for (var p = o; ++c < a; ) {
                    var g = t[u = l[c]]
                      , m = e[u];
                    if (r)
                        var b = o ? r(m, g, u, e, t, i) : r(g, m, u, t, e, i);
            ...
            class Gr extends cn {
                cache = {};
                delta() {
                    return null == this.cache.delta && (this.cache.delta = Yr(this)),
                    this.cache.delta
                }
                deleteAt(t, e) {
                    super.deleteAt(t, e),
                ...
                formatAt(t, e, n, r) {
                    e <= 0 || (this.scroll.query(n, ze.BLOCK) ? t + e === this.length() && this.format(n, r) : super.formatAt(t, Math.min(e, this.length() - t - 1), n, r),
                    this.cache = {})
                }
                insertAt(t, e, n) {
                    if (null != n)
                    ...
                    const r = e.split("\n")
                      , s = r.shift();
                    s.length > 0 && (t < this.length() - 1 || null == this.children.tail ? super.insertAt(Math.min(t, this.length() - 1), s) : this.children.tail.insertAt(this.children.tail.length(), s),
                    this.cache = {});
                    let i = this;
                    r.reduce(( (t, e) => (i = i.split(t, !0),
                    i.insertAt(0, e),
                    e.length)), t + s.length)
                }
                insertBefore(t, e) {
            ...
            function Yr(t) {
                let e = !(arguments.length > 1 && void 0 !== arguments[1]) || arguments[1];
                return t.descendants(tn).reduce(( (t, n) => 0 === n.length() ? t : t.insert(n.value(), Qr(n, {}, e))), new vn).insert("\n", Qr(t))
            }
            function Qr(t) {
                let e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}
                ...
                null == t.parent || "scroll" === t.parent.statics.blotName || t.parent.statics.scope !== t.statics.scope ? e : Qr(t.parent, e, n))
            }
            ...
            class Jr extends dn {
                ...
                format(t, e) {
                    ...
                    for (; null != n && n.statics.scope !== ze.BLOCK_BLOT; )
                        r += n.offset(n.parent),
                        n = n.parent;
                    null != n && (this.savedLength = Jr.CONTENTS.length,
                    n.optimize(),
                ...
                restore() {
                    ...
                    if (this.remove(),
                    t) {
                        const s = (t, s) => e && t === e.domNode ? s : t === i ? n + s - 1 : r && t === r.domNode ? n + o.length + s : null
            ...
            function os(t) {
                return rs.reduce(( (e, n) => (e[n] = is.bind(console, n, t),
                e)), {})
            }
            os.level = t => {
                ss = t
            ...
            var cs = class extends es {
                ...
                constructor() {
                    super(),
                    this.domListeners = {},
                    this.on("error", as.error)
                }
                emit() {
                    for (var t = arguments.length, e = new Array(t), n = 0; n < t; n++)
                        e[n] = arguments[n];
                    return as.log.call(as, ...e),
                    super.emit(...e)
                }
                handleDOM(t) {
                    for (var e = arguments.length, n = new Array(e > 1 ? e - 1 : 0), r = 1; r < e; r++)
            ...
            var fs = class {
                constructor(t, e) {
                    ...
                    this.emitter.on(cs.events.SCROLL_BEFORE_UPDATE, ( () => {
                        ...
                        null != t && t.start.node !== this.cursor.textNode && this.emitter.once(cs.events.SCROLL_UPDATE, ( (e, n) => {
                            try {
                ...
                getBounds(t) {
                    ...
                    if (e > 0)
                        return o.setStart(r, i),
                        [s,i] = this.scroll.leaf(t + e),
                        null == s ? null : ([r,i] = s.position(i, !0),
                        o.setEnd(r, i),
                    ...
                    if (r instanceof Text) {
                        if (!r.data.length)
                            return null;
                        i < r.data.length ? (o.setStart(r, i),
                        o.setEnd(r, i + 1)) : (o.setStart(r, i - 1),
                        o.setEnd(r, i),
                        a = "right"),
                        ...
                        if (!(s.domNode instanceof Element))
                            return null;
                        l = s.domNode.getBoundingClientRect(),
                        i > 0 && (a = "right")
                    }
                    return {
                ...
                getNativeRange() {
                    ...
                    return us.info("getNativeRange", n),
                    n
                }
                getRange() {
                ...
                hasFocus() {
                    return document.activeElement === this.root || null != document.activeElement && ds(this.root, document.activeElement)
                }
                normalizedToRange(t) {
                ...
                setNativeRange(t, e) {
                    ...
                    if (us.info("setNativeRange", t, e, n, r),
                    ...
                    if (null != i)
                        if (null != t) {
                            ...
                            if (null == o || s || t !== o.startContainer || e !== o.startOffset || n !== o.endContainer || r !== o.endOffset) {
            ...
            function gs(t, e, n) {
                ...
                if (o > e)
                    return n.push(l),
                    o === e + 1 ? `<${c}><li${u}>${ms(r, s, i)}${gs(a, o, n)}` : `<${c}><li>${gs(t, e + 1, n)}`;
            ...
            function bs(t, e) {
                return Object.keys(e).reduce(( (n, r) => {
                    if (null == t[r])
                        return n;
                    const s = e[r];
                    return s === t[r] ? n[r] = s : Array.isArray(s) ? s.indexOf(t[r]) < 0 ? n[r] = s.concat([t[r]]) : n[r] = s : n[r] = [s, t[r]],
                    n
                }
                ), {})
            }
            ...
            var Ns = class {
                ...
                applyDelta(t) {
                            ...
                            "string" == typeof n.insert) {
                                ...
                                if (s)
                                    ...
                                    if (e instanceof $r) {
                                        ...
                                        e instanceof dn && e.statics.scope === ze.INLINE_BLOT && (o = !0)
                                }
                                if (this.scroll.insertAt(t, r, n.insert[r]),
                                s) {
                    ...
                    r.reduce(( (t, e) => "number" == typeof e.delete ? (this.scroll.deleteAt(t, e.delete),
                    t) : t + vn.Op.length(e)), 0),
                ...
                insertEmbed(t, e, n) {
                    ...
                    this.update((new vn).retain(t).insert({
                        [e]: n
                    }))
                }
                insertText(t, e) {
                ...
                isBlank() {
                    ...
                    if (t?.statics.blotName !== Gr.blotName)
                        return !1;
                    const e = t;
                ...
                removeFormat(t, e) {
                    ...
                    let i = 0
                      , o = new vn;
                    null != r && (i = r.length() - s,
                    o = r.delta().slice(s, s + i - 1).insert("\n"));
                ...
                update(t) {
                    ...
                    const r = this.delta;
                    if (1 === e.length && "characterData" === e[0].type && e[0].target.data.match(ps) && this.scroll.find(e[0].target)) {
                        ...
                        t = (new vn).retain(o).concat(a.diff(c, u)).reduce(( (t, e) => e.insert ? t.insert(e.insert, i) : t.push(e)), new vn),
                        this.delta = r.compose(t)
                    } else
                        this.delta = this.getDelta(),
                        t && zr(r.compose(t), this.delta) || (t = r.diff(this.delta, n));
                    return t
                }
            }
            ;
            ...
            var As = class extends dn {
                ...
                restore(t) {
                    ...
                    if (t === this.leftGuard)
                        ...
                        t === this.rightGuard && (this.next instanceof $r ? (this.next.insertAt(0, r),
                        n = {
            ...
            var qs = class {
                ...
                handleCompositionStart(t) {
                    ...
                    !e || e instanceof As || (this.emitter.emit(cs.events.COMPOSITION_BEFORE_START, t),
                    this.scroll.batchStart(),
            ...
            const Ls = t => {
              ...
              , Ss = (t, e, n, r, s, i) => t < n && e > r ? 0 : t < n ? -(n - t + s) : e > r ? e - t > r - n ? t + s - n : e - r + i : 0;
            var Ts = (t, e) => {
            ...
            class Ms {
                ...
                static import(t) {
                    return null == this.imports[t] && Rs.error(`Cannot import ${t}. Are you sure it was registered?`),
                    this.imports[t]
                }
                static register() {
                    if ("string" != typeof (arguments.length <= 0 ? void 0 : arguments[0])) {
                        ...
                        this.imports[t] = e,
                        (t.startsWith("blots/") || t.startsWith("formats/")) && e && "boolean" != typeof e && "abstract" !== e.blotName && Is.register(e),
                ...
                constructor(t) {
                    ...
                    if (this.options = function(t, e) {
                        ...
                        let d = e.registry;
                        d ? e.formats && Rs.warn('Ignoring "formats" option because "registry" is specified') : d = e.formats ? Cs(e.formats, h.registry, Rs) : h.registry;
                        return {
                            ...h,
                            registry: d,
                            container: n,
                            ...
                            modules: Object.entries(u).reduce(( (t, e) => {
                                ...
                                return null == s ? (Rs.error(`Cannot load ${n} module. Are you sure you registered it?`),
                                t) : {
                                    ...t,
                                    [n]: Pe({}, s.DEFAULTS || {}, r)
                                }
                    ...
                    this.emitter.on(cs.events.SCROLL_EMBED_UPDATE, ( (t, e) => {
                        ...
                        Ps.call(this, ( () => {
                            const n = (new vn).retain(t.offset(this)).retain({
                ...
                format(t, e) {
                    ...
                    return Ps.call(this, ( () => {
                        ...
                        return this.setSelection(n, cs.sources.SILENT),
                        r
                    }
                    ), n)
                }
                ...
                insertText(t, e, n, r, s) {
                    let i;
                    return [t,,i,s] = zs(t, 0, n, r, s),
                    Ps.call(this, ( () => this.editor.insertText(t, e, i)), s, t, e.length)
                }
                isEnabled() {
                ...
                setSelection(t, e, n) {
                    null == t ? this.selection.setRange(null, e || Ms.sources.API) : ([t,e,,n] = zs(t, e, n),
                ...
                updateContents(t) {
                    let e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : cs.sources.API;
                    return Ps.call(this, ( () => (t = new vn(t),
            ...
            function Ps(t, e, n, r) {
                if (!this.isEnabled() && e === cs.sources.USER && !this.allowReadOnlyEdits)
                    return new vn;
                let s = null == n ? null : this.getSelection();
                const i = this.editor.delta
                  , o = t();
                if (null != s && (!0 === n && (n = s.index),
            ...
            function zs(t, e, n, r, s) {
                let i = {};
                return "number" == typeof t.index && "number" == typeof t.length ? "number" != typeof e ? (s = r,
                r = n,
                n = e,
                e = t.length,
                t = t.index) : (e = t.length,
                t = t.index) : "number" != typeof e && (s = r,
                r = n,
                n = e,
                e = 0),
                "object" == typeof n ? (i = n,
                s = r) : "string" == typeof n && (null != r ? i[n] = r : s = n),
            ...
            function Fs(t, e, n, r) {
                ...
                if (null == t)
                    return null;
                let i, o;
                return e && "function" == typeof e.transformPosition ? [i,o] = [t.index, t.index + t.length].map((t => e.transformPosition(t, r !== cs.sources.USER))) : [i,o] = [t.index, t.index + t.length].map((t => t < e || t === e && r === cs.sources.USER ? t : s >= 0 ? t + s : Math.max(e, t + s))),
                new hs(i,o - i)
            }
            ...
            var Ws = class extends gn {
                ...
                insertContents(t, e) {
                    ...
                    if (s) {
                        const e = "block" === s.type && (0 === s.delta.length() || !this.descendant(Xr, t)[0] && t < this.length())
                          , n = "block" === s.type ? s.delta : (new vn).insert({
                            [s.key]: s.value
                        });
                        Ks(this, t, n);
                ...
                lines() {
                    ...
                    const n = (t, e, r) => {
                        ...
                        return t.children.forEachAt(e, r, ( (t, e, r) => {
                            $s(t) ? s.push(t) : t instanceof hn && (s = s.concat(n(t, e, i))),
                            i -= r
                        }
                        )),
                        s
                ...
                optimize() {
                    ...
                    t.length > 0 && this.emitter.emit(cs.events.SCROLL_OPTIMIZE, t, e))
                }
                path(t) {
                    ...
                    return t.forEach((t => {
                        ...
                        if (r)
                            if ("string" == typeof r) {
                                ...
                                if (!s)
                                    return;
                                this.query(s, ze.INLINE) ? n.push(t) : (n.length() && e.push({
                                    type: "block",
                                    delta: n,
                                    attributes: {}
                                }),
            ...
            class Qs extends Ge {
                value(t) {
                    ...
                    return `#${e.split(",").map((t => `00${parseInt(t, 10).toString(16)}`.slice(-2))).join("")}`
                }
            }
            const Js = new We("color","ql-color",{
                scope: ze.INLINE
            })
              , ti = new Qs("color","color",{
                scope: ze.INLINE
            })
              , ei = new We("background","ql-bg",{
                scope: ze.INLINE
            })
              , ni = new Qs("background","background-color",{
                scope: ze.INLINE
            });
            class ri extends Hs {
                static create(t) {
            ...
            class bi extends Es {
                ...
                addBinding(t) {
                    ...
                    const r = function(t) {
                        ...
                        t.shortKey && (t[mi] = t.shortKey,
                        delete t.shortKey);
                        return t
                    }(t);
                    if (null == r)
                        return void gi.warn("Attempted to add invalid keyboard binding", r);
                    "function" == typeof e && (e = {
                        handler: e
                    }),
                    "function" == typeof n && (n = {
                        ...
                        e.some((t => {
                            ...
                            if (Array.isArray(t.format)) {
                                if (t.format.every((t => null == d.format[t])))
                                    return !1
                            } else if ("object" == typeof t.format && !Object.keys(t.format).every((e => !0 === t.format[e] ? null != d.format[e] : !1 === t.format[e] ? null == d.format[e] : zr(t.format[e], d.format[e]))))
                                return !1;
                ...
                handleBackspace(t, e) {
                    ...
                    this.quill.updateContents(i, Ms.sources.USER),
                    this.quill.focus()
                }
                handleDelete(t, e) {
                ...
                handleEnter(t, e) {
                    const n = Object.keys(e.format).reduce(( (t, n) => (this.quill.scroll.query(n, ze.BLOCK) && !Array.isArray(e.format[n]) && (t[n] = e.format[n]),
                    t)), {})
            ...
            const vi = {
                bindings: {
                    ...
                    indent: {
                        ...
                        handler(t, e) {
                            return !(!e.collapsed || 0 === e.offset) || (this.quill.format("indent", "+1", Ms.sources.USER),
                            !1)
                        }
                    },
                    outdent: {
                    ...
                    "outdent backspace": {
                        ...
                        offset: 0,
                        handler(t, e) {
                            null != e.format.indent ? this.quill.format("indent", "-1", Ms.sources.USER) : null != e.format.list && this.quill.format("list", !1, Ms.sources.USER)
                        }
                    },
                    ...
                    tab: {
                        ...
                        handler(t, e) {
                            ...
                            return this.quill.updateContents(n, Ms.sources.USER),
                            this.quill.history.cutoff(),
                            this.quill.setSelection(t.index + 1, Ms.sources.SILENT),
                            !1
                        }
                    ...
                    "checklist enter": {
                        ...
                        handler(t) {
                            const [e,n] = this.quill.getLine(t.index)
                              ...
                              , s = (new vn).retain(t.index).insert("\n", r).retain(e.length() - n - 1).retain(1, {
                                list: "unchecked"
                            });
                    ...
                    "table tab": {
                        ...
                        handler(t, e) {
                            ...
                            n.shiftKey ? this.quill.setSelection(s - 1, Ms.sources.USER) : this.quill.setSelection(s + r.length(), Ms.sources.USER)
                        }
                    },
                    "list autofill": {
                        key: " ",
                        ...
                        handler(t, e) {
                            ...
                            this.quill.history.cutoff();
                            const o = (new vn).retain(t.index - s).delete(n + 1).retain(r.length() - 2 - s).retain(1, {
                                list: i
                            });
                            return this.quill.updateContents(o, Ms.sources.USER),
                            this.quill.history.cutoff(),
                    ...
                    "code exit": {
                        ...
                        handler(t) {
                            ...
                            for (; null != s && s.length() <= 1 && s.formats()["code-block"]; )
                                ...
                                r -= 1,
                                r <= 0) {
                                    const r = (new vn).retain(t.index + e.length() - n - 2).retain(1, {
                                        "code-block": null
                                    }).delete(1);
                                    return this.quill.updateContents(r, Ms.sources.USER),
                                    this.quill.setSelection(t.index - 1, Ms.sources.SILENT),
                                    !1
                                }
                            return !0
                ...
                return {
                    ...
                    handler(e, n) {
                        ...
                        if (0 === e.length && !r.shiftKey)
                            return this.quill.insertText(e.index, i, Ms.sources.USER),
                        ...
                        o.forEach(( (e, n) => {
                            t ? (e.insertAt(0, i),
                            0 === n ? l += i.length : a += i.length) : e.domNode.textContent.startsWith(i) && (e.deleteAt(0, i.length),
            ...
            function xi(t, e) {
                ...
                return {
                    ...
                    handler(n) {
                        ...
                        return !(s instanceof dn) || ("ArrowLeft" === t ? e ? this.quill.setSelection(n.index - 1, n.length + 1, Ms.sources.USER) : this.quill.setSelection(n.index - 1, Ms.sources.USER) : e ? this.quill.setSelection(n.index, n.length + 1, Ms.sources.USER) : this.quill.setSelection(n.index + n.length + 1, Ms.sources.USER),
                        !1)
                    }
                }
            }
                ...
                return {
                    ...
                    handler(e, n) {
                        ...
                        if (null != i) {
                            ...
                            const e = s.table()[r];
                            null != e && (t ? this.quill.setSelection(e.offset(this.quill.scroll) + e.length() - 1, 0, Ms.sources.USER) : this.quill.setSelection(e.offset(this.quill.scroll), 0, Ms.sources.USER))
                        }
                        return !1
                    }
                }
            ...
            const _i = /\bmso-list:[^;]*ignore/i
              ...
              , Si = t => {
                ...
                for (; i.length; ) {
                    ...
                    for (; e; )
                        t.push(e),
                        e = i.length && i[0]?.element === e.element.nextElementSibling && i[0].id === e.id ? i.shift() : null;
            ...
            , function(t) {
                t.querySelector('[id^="docs-internal-guid-"]') && ((t => {
                    Array.from(t.querySelectorAll('b[style*="font-weight"]')).filter((t => t.getAttribute("style")?.match(Ai))).forEach((e => {
                ...
                (t => {
                    Array.from(t.querySelectorAll("br")).filter((t => ki(t.previousElementSibling) && ki(t.nextElementSibling))).forEach((t => {
            ...
            var ji = t => {
                t.documentElement && Ti.forEach((e => {
                    e(t)
                }
                ))
            }
            ...
            const Ci = ls("quill:clipboard")
              , Ri = [[Node.TEXT_NODE, function(t, e, n) {
                let r = t.data;
                if ("O:P" === t.parentElement?.tagName)
                    return e.insert(r.trim());
                if (!zi(t)) {
                    if (0 === r.trim().length && r.includes("\n") && !function(t, e) {
                        return t.previousElementSibling && t.nextElementSibling && !Ui(t.previousElementSibling, e) && !Ui(t.nextElementSibling, e)
                    }(t, n))
                        return e;
                    r = r.replace(/[^\S\u00a0]/g, " "),
                    r = r.replace(/ {2,}/g, " "),
                    (null == t.previousSibling && null != t.parentElement && Ui(t.parentElement, n) || t.previousSibling instanceof Element && Ui(t.previousSibling, n)) && (r = r.replace(/^ /, "")),
                    (null == t.nextSibling && null != t.parentElement && Ui(t.parentElement, n) || t.nextSibling instanceof Element && Ui(t.nextSibling, n)) && (r = r.replace(/ $/, "")),
                    r = r.replaceAll(" ", " ")
                }
                return e.insert(r)
            }
            ], [Node.TEXT_NODE, $i], ["br", function(t, e) {
                Di(e, "\n") || e.insert("\n");
                return e
            }
            ], [Node.ELEMENT_NODE, $i], [Node.ELEMENT_NODE, function(t, e, n) {
                const r = n.query(t);
                if (null == r)
                    return e;
                if (r.prototype instanceof dn) {
                    const e = {}
                      , s = r.value(t);
                    if (null != s)
                        return e[r.blotName] = s,
                        (new vn).insert(e, r.formats(t, n))
                } else if (r.prototype instanceof cn && !Di(e, "\n") && e.insert("\n"),
                ...
                const r = Fe.keys(t)
                  ...
                  , i = Ge.keys(t)
                  , o = {};
                return r.concat(s).concat(i).forEach((e => {
                    let r = n.query(e, ze.ATTRIBUTE);
                    null != r && (o[r.attrName] = r.value(t),
                    o[r.attrName]) || (r = Ii[e],
                    null == r || r.attrName !== e && r.keyName !== e || (o[r.attrName] = r.value(t) || void 0),
                    r = Mi[e],
                    null == r || r.attrName !== e && r.keyName !== e || (r = Mi[e],
                ...
                if (e = Object.entries(r).reduce(( (t, e) => {
                    let[r,s] = e;
                    return Bi(t, r, s, n)
                }
                ), e),
            ...
            ], ["b", Hi("bold")], ["i", Hi("italic")], ["strike", Hi("strike")], ["style", function() {
                return new vn
            }
            ]]
              , Ii = [Gs, li].reduce(( (t, e) => (t[e.keyName] = e,
            t)), {})
              , Mi = [Ys, ni, ti, ci, di, pi].reduce(( (t, e) => (t[e.keyName] = e,
            t)), {});
            function Bi(t, e, n, r) {
            ...
            function Ui(t, e) {
                if (!(t instanceof Element))
                    return !1;
                const n = e.query(t);
                return !(n && n.prototype instanceof dn) && ["address", "article", "blockquote", "canvas", "dd", "div", "dl", "dt", "fieldset", "figcaption", "figure", "footer", "form", "h1", "h2", "h3", "h4", "h5", "h6", "header", "iframe", "li", "main", "nav", "ol", "output", "p", "pre", "section", "table", "td", "tr", "ul", "video"].includes(t.tagName.toLowerCase())
            }
            const Pi = new WeakMap;
            function zi(t) {
                return null != t && (Pi.has(t) || ("PRE" === t.tagName ? Pi.set(t, !0) : Pi.set(t, zi(t.parentNode))),
                Pi.get(t))
            }
            function Fi(t, e, n, r, s) {
                return e.nodeType === e.TEXT_NODE ? r.reduce(( (n, r) => r(e, n, t)), new vn) : e.nodeType === e.ELEMENT_NODE ? Array.from(e.childNodes || []).reduce(( (i, o) => {
                    let l = Fi(t, o, n, r, s);
            ...
            function $i(t, e, n) {
                if (!Di(e, "\n")) {
                    if (Ui(t, n) && (t.childNodes.length > 0 || t instanceof HTMLParagraphElement))
                        return e.insert("\n");
                    if (e.length() > 0 && t.nextSibling) {
                        ...
                        for (; null != r; ) {
                            if (Ui(r, n))
                                return e.insert("\n");
                            const t = n.query(r);
                            if (t && t.prototype instanceof Xr)
                                return e.insert("\n");
                            r = r.firstChild
                        }
                    }
            ...
            var Xi = class extends Es {
                constructor(t, e) {
                    ...
                    /Android/i.test(navigator.userAgent) || t.on(Ms.events.COMPOSITION_BEFORE_START, ( () => {
                ...
                replaceText(t) {
                    ...
                    if (e) {
                        ...
                        this.deleteRange(t),
                        this.quill.updateContents((new vn).retain(t.index).insert(e, n), Ms.sources.USER)
                    } else
                        this.deleteRange(t);
                    return this.quill.setSelection(t.index + e.length, 0, Ms.sources.SILENT),
                    !0
                }
                handleBeforeInput(t) {
                    if (this.quill.composition.isComposing || t.defaultPrevented || !Gi.includes(t.inputType))
                        return;
            ...
            var Qi = class extends Es {
                ...
                handleArrowKeys() {
                    this.quill.keyboard.addBinding({
                        ...
                        handler(t, e) {
                            ...
                            if (!(n instanceof sn && n.uiNode))
                                return !0;
                            const s = "rtl" === getComputedStyle(n.domNode).direction;
                            return !!(s && "ArrowRight" !== r.key || !s && "ArrowLeft" !== r.key) || (this.quill.setSelection(t.index - 1, t.length + (r.shiftKey ? 1 : 0), Ms.sources.USER),
                            !1)
                        }
                    })
                }
                handleNavigationShortcuts() {
                    this.quill.root.addEventListener("keydown", (t => {
                        !t.defaultPrevented && (t => "ArrowLeft" === t.key || "ArrowRight" === t.key || "ArrowUp" === t.key || "ArrowDown" === t.key || "Home" === t.key || !(!Yi || "a" !== t.key || !0 !== t.ctrlKey))(t) && this.ensureListeningToSelectionChange()
                    }
                    ))
                }
                ensureListeningToSelectionChange() {
                    if (this.selectionChangeDeadline = Date.now() + 100,
                    this.isListening)
                        return;
                    this.isListening = !0;
            ...
            Ms.register({
                ...
                "modules/clipboard": class extends Es {
                    ...
                    convert(t) {
                        ...
                        if (!e)
                            return (new vn).insert(n || "", r);
                        const s = this.convertHTML(e);
                        return Di(s, "\n") && (null == s.ops[s.ops.length - 1].attributes || r.table) ? s.compose((new vn).retain(s.length() - 1).delete(1)) : s
                    }
                    normalizeHTML(t) {
                        ji(t)
                    }
                ...
                "modules/history": class extends Es {
                    ...
                    constructor(t, e) {
                        ...
                        this.quill.on(Ms.events.EDITOR_CHANGE, ( (t, e, n, r) => {
                            t === Ms.events.SELECTION_CHANGE ? e && r !== Ms.sources.SILENT && (this.currentRange = e) : t === Ms.events.TEXT_CHANGE && (this.ignoreChange || (this.options.userOnly && r !== Ms.sources.USER ? this.transform(e) : this.record(e, n)),
                    ...
                    transform(t) {
                        Vi(this.stack.undo, t),
                        Vi(this.stack.redo, t)
                    }
                    undo() {
                    ...
                    restoreSelection(t) {
                        if (t.range)
                            this.quill.setSelection(t.range, Ms.sources.USER);
                        else {
                            const e = function(t, e) {
                                ...
                                (function(t, e) {
                                    ...
                                    if (null == n)
                                        return !1;
                                    if (null != n.insert)
                                        return "string" == typeof n.insert && n.insert.endsWith("\n");
            ...
            var mo = class extends dn {
                ...
                static formats(t) {
                    return go.reduce(( (e, n) => (t.hasAttribute(n) && (e[n] = t.getAttribute(n)),
                    e)), {})
                }
                static match(t) {
            ...
            var vo = class extends Xr {
                ...
                static formats(t) {
                    return bo.reduce(( (e, n) => (t.hasAttribute(n) && (e[n] = t.getAttribute(n)),
                    e)), {})
                }
                static sanitize(t) {
            ...
            ;
            const yo = new We("code-token","hljs",{
                scope: ze.INLINE
            });
            class xo extends Zr {
                static formats(t, e) {
                ...
                constructor(t, e, n) {
                    super(t, e, n),
                    yo.add(this.domNode, n)
                }
                format(t, e) {
                    t !== xo.blotName ? super.format(t, e) : e ? yo.add(this.domNode, e) : (yo.remove(this.domNode),
            ...
            xo.blotName = "code-token",
            xo.className = "ql-token";
            class No extends si {
                static create(t) {
                    const e = super.create(t);
                ...
                replaceWith(t, e) {
                    return this.formatAt(0, this.length(), xo.blotName, !1),
            ...
            class Eo extends ri {
                ...
                format(t, e) {
                    t === No.blotName && (this.forceNext = !0,
                    this.children.forEach((n => {
                        n.format(t, e)
                    }
                    )))
            ...
            class wo extends Es {
                ...
                initListener() {
                    this.quill.on(Ms.events.SCROLL_BLOT_MOUNT, (t => {
                        ...
                        t.children.head && (e.value = No.formats(t.children.head.domNode)))
                    }
                    ))
                }
                initTimer() {
                ...
                highlightBlot(t) {
                    ...
                    return n.classList.add(si.className),
                    n.innerHTML = ( (t, e, n) => {
                    ...
                    Fi(this.quill.scroll, n, [ (t, e) => {
                        const n = yo.value(t);
                        return n ? e.compose((new vn).retain(e.length(), {
                            [xo.blotName]: n
                        })) : e
                    }
                    ], [ (t, n) => t.data.split("\n").reduce(( (t, n, r) => (0 !== r && t.insert("\n", {
            ...
            class Ao extends Gr {
                ...
                static create(t) {
                    const e = super.create();
                    return t ? e.setAttribute("data-row", t) : e.setAttribute("data-row", Lo()),
                    e
                }
                static formats(t) {
            ...
            var Oo = class extends Es {
                ...
                insertRow(t) {
                    ...
                    n.insertRow(i + t),
                    this.quill.update(Ms.sources.USER),
                    t > 0 ? this.quill.setSelection(e, Ms.sources.SILENT) : this.quill.setSelection(e.index + r.children.length, e.length, Ms.sources.SILENT)
                }
                insertRowAbove() {
                    this.insertRow(0)
                }
                ...
                listenBalanceCells() {
                    this.quill.on(Ms.events.SCROLL_OPTIMIZE, (t => {
                        t.some((t => !!["TD", "TR", "TBODY", "TABLE"].includes(t.target.tagName) && (this.quill.once(Ms.events.TEXT_CHANGE, ( (t, e, n) => {
                ...
                attach(t) {
                    ...
                    t.addEventListener(n, (n => {
                        ...
                        if (null != this.handlers[e])
                            ...
                            !r)
                                return;
                            this.quill.updateContents((new vn).retain(s.index).delete(s.length).insert({
                                [e]: r
                            }), Ms.sources.USER)
                        } else
                            this.quill.format(e, r, Ms.sources.USER);
                        this.update(s)
                    }
                    )),
                    ...
                    this.controls.forEach((n => {
                        ...
                        if ("SELECT" === s.tagName) {
                            ...
                            if (null == t)
                                ...
                                n = s.querySelector("option[selected]");
                            ...
                            null == n ? (s.value = "",
                            s.selectedIndex = -1) : n.selected = !0
                        } else if (null == t)
            ...
            To.DEFAULTS = {
                ...
                handlers: {
                    ...
                    direction(t) {
                        ...
                        "rtl" === t && null == e ? this.quill.format("align", "right", Ms.sources.USER) : t || "right" !== e || this.quill.format("align", !1, Ms.sources.USER),
                    ...
                    list(t) {
                        const e = this.quill.getSelection()
                          , n = this.quill.getFormat(e);
                        "check" === t ? "checked" === n.list || "unchecked" === n.list ? this.quill.format("list", !1, Ms.sources.USER) : this.quill.format("list", "unchecked", Ms.sources.USER) : this.quill.format("list", t, Ms.sources.USER)
                    }
                }
            };
            const Co = '<svg viewbox="0 0 18 18"><polyline class="ql-even ql-stroke" points="5 7 3 9 5 11"/><polyline class="ql-even ql-stroke" points="13 7 15 9 13 11"/><line class="ql-stroke" x1="10" x2="8" y1="5" y2="13"/></svg>';
            var Ro = {
                align: {
            ...
            var Po = class {
                ...
                position(t) {
                    ...
                    let i = 0;
                    if (s.right > r.right && (i = r.right - s.right,
                    this.root.style.left = `${e + i}px`),
                    s.left < r.left && (i = r.left - s.left,
                    this.root.style.left = `${e + i}px`),
                    s.bottom > r.bottom) {
            ...
            const zo = [!1, "center", "right", "justify"]
              , Fo = ["#000000", "#e60000", "#ff9900", "#ffff00", "#008a00", "#0066cc", "#9933ff", "#ffffff", "#facccc", "#ffebcc", "#ffffcc", "#cce8cc", "#cce0f5", "#ebd6ff", "#bbbbbb", "#f06666", "#ffc266", "#ffff66", "#66b966", "#66a3e0", "#c285ff", "#888888", "#a10000", "#b26b00", "#b2b200", "#006100", "#0047b2", "#6b24b2", "#444444", "#5c0000", "#663d00", "#666600", "#003700", "#002966", "#3d1466"]
            ...
            class Ko extends _s {
                ...
                buildPickers(t, e) {
                    this.pickers = Array.from(t).map((t => {
                        if (t.classList.contains("ql-align") && (null == t.querySelector("option") && Zo(t, zo),
                        ...
                        if (t.classList.contains("ql-background") || t.classList.contains("ql-color")) {
                            ...
                            return null == t.querySelector("option") && Zo(t, Fo, "background" === n ? "#ffffff" : "#000000"),
                            new Do(t,e[n])
                        }
                        return null == t.querySelector("option") && (t.classList.contains("ql-font") ? Zo(t, Ho) : t.classList.contains("ql-header") ? Zo(t, $o) : t.classList.contains("ql-size") && Zo(t, Vo)),
                        new Bo(t)
                    }
                    ));
                    ...
                    case "link":
                        {
                            ...
                            this.linkRange ? (this.quill.formatText(this.linkRange, "link", t, cs.sources.USER),
                    ...
                    case "formula":
                        {
                            ...
                            if (null != e) {
                                ...
                                "formula" === this.root.getAttribute("data-mode") && this.quill.insertText(n + 1, " ", cs.sources.USER),
