    ...
    return function() {
        var e = {
            8731: function(e, r, n) {
                var i, t, l;
                t = [n(2077)],
                void 0 === (l = "function" == typeof (i = function(e) {
                    var r;
                ...
                i = function() {
                    ...
                    return (e = function(n) {
                        ...
                        if (e.isNumeral(n))
                            ...
                            if (u.zeroFormat && n === u.zeroFormat)
                                ...
                                for (t in o)
                                    if ((a = "function" == typeof o[t].regexps.unformat ? o[t].regexps.unformat() : o[t].regexps.unformat) && n.match(a)) {
                                        l = o[t].unformat;
                                        break
                                    }
                    ...
                    e._ = r = {
                        numberToFormat: function(r, n, i) {
                            var t, l, o, s, u, c, m, d = a[e.options.currentLocale], b = !1, f = !1, h = 0, y = "", p = 1e12, v = 1e9, g = 1e6, _ = 1e3, x = "", F = !1;
                            if (r = r || 0,
                            l = Math.abs(r),
                            e._.includes(n, "(") ? (b = !0,
                            n = n.replace(/[\(|\)]/g, "")) : (e._.includes(n, "+") || e._.includes(n, "-")) && (u = e._.includes(n, "+") ? n.indexOf("+") : r < 0 ? n.indexOf("-") : -1,
                            n = n.replace(/[\+|\-]/g, "")),
                            e._.includes(n, "a") && (t = !!(t = n.match(/a(k|m|b|t)?/)) && t[1],
                            e._.includes(n, " a") && (y = " "),
                            n = n.replace(new RegExp(y + "a[kmbt]?"), ""),
                            l >= p && !t || "t" === t ? (y += d.abbreviations.trillion,
                            r /= p) : l < p && l >= v && !t || "b" === t ? (y += d.abbreviations.billion,
                            r /= v) : l < v && l >= g && !t || "m" === t ? (y += d.abbreviations.million,
                            r /= g) : (l < g && l >= _ && !t || "k" === t) && (y += d.abbreviations.thousand,
                            r /= _)),
                            e._.includes(n, "[.]") && (f = !0,
                            n = n.replace("[.]", ".")),
                            ...
                            x = e._.toFixed(r, s[0].length + s[1].length, i, s[1].length)) : x = e._.toFixed(r, s.length, i),
                            o = x.split(".")[0],
                            x = e._.includes(x, ".") ? d.delimiters.decimal + x.split(".")[1] : "",
                            f && 0 === Number(x.slice(1)) && (x = "")) : o = e._.toFixed(r, 0, i),
                            y && !t && Number(o) >= 1e3 && y !== d.abbreviations.trillion)
                                switch (o = String(Number(o) / 1e3),
                                y) {
                            ...
                            if (e._.includes(o, "-") && (o = o.slice(1),
                            F = !0),
                            o.length < h)
                                for (var k = h - o.length; k > 0; k--)
                                    o = "0" + o;
                            return c > -1 && (o = o.toString().replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1" + d.delimiters.thousands)),
                            0 === n.indexOf(".") && (o = ""),
                            m = o + x + (y || ""),
                            b ? m = (b && F ? "(" : "") + m + (b && F ? ")" : "") : u >= 0 ? m = 0 === u ? (F ? "-" : "+") + m : m + (F ? "-" : "+") : F && (m = "-" + m),
                            m
                        },
                        stringToNumber: function(e) {
                            var r, n, i, t = a[u.currentLocale], l = e, o = {
                                thousand: 3,
                                million: 6,
                                billion: 9,
                                trillion: 12
                            ...
                            if (u.zeroFormat && e === u.zeroFormat)
                                ...
                                o)
                                    if (i = new RegExp("[^a-zA-Z]" + t.abbreviations[r] + "(?:\\)|(\\" + t.currency.symbol + ")?(?:\\))?)?$"),
                                    l.match(i)) {
                                        n *= Math.pow(10, o[r]);
                                        break
                                    }
                        ...
                        reduce: function(e, r) {
                            ...
                            var n, i = Object(e), t = i.length >>> 0, l = 0;
                        ...
                        toFixed: function(e, r, n, i) {
                            var t, l, o, a, s = e.toString().split("."), u = r - (i || 0);
                            return t = 2 === s.length ? Math.min(Math.max(s[1].length, u), r) : u,
                            o = Math.pow(10, t),
                            a = (n(e + "e+" + t) / o).toFixed(t),
                            i > r - t && (l = new RegExp("\\.?0{1," + (i - (r - t)) + "}$"),
                            a = a.replace(l, "")),
                            a
                        }
                    },
                    ...
                    e.validate = function(r, n) {
                        ...
                        return l = u.currency.symbol,
                        a = u.abbreviations,
                        i = u.delimiters.decimal,
                        t = "." === u.delimiters.thousands ? "\\." : u.delimiters.thousands,
                        !(null !== (c = r.match(/^[^\d]+/)) && (r = r.substr(1),
                        c[0] !== l) || null !== (c = r.match(/[^\d]+$/)) && (r = r.slice(0, -1),
                        c[0] !== a.thousand && c[0] !== a.million && c[0] !== a.billion && c[0] !== a.trillion) || (s = new RegExp(t + "{2}"),
                        r.match(/[^\d.,]/g) || (o = r.split(i)).length > 2 || (o.length < 2 ? !o[0].match(/^\d+.*\d$/) || o[0].match(s) : 1 === o[0].length ? !o[0].match(/^\d+$/) || o[0].match(s) || !o[1].match(/^\d+$/) : !o[0].match(/^\d+.*\d$/) || o[0].match(s) || !o[1].match(/^\d+$/))))
                    }
                    ,
                    e.fn = c.prototype = {
                        clone: function() {
                        ...
                        format: function(r, n) {
                            var i, t, l, a = this._value, s = r || u.defaultFormat;
                            if (n = n || Math.round,
                            0 === a && null !== u.zeroFormat)
                                t = u.zeroFormat;
                        ...
                        add: function(e) {
                            ...
                            return this._value = r.reduce([this._value, e], i, 0) / n,
                            this
                        },
                        subtract: function(e) {
                            var n = r.correctionFactor.call(null, this._value, e);
                            ...
                            return this._value = r.reduce([e], i, Math.round(this._value * n)) / n,
                            this
                        },
                        multiply: function(e) {
                            function n(e, n, i, t) {
                            ...
                            return this._value = r.reduce([this._value, e], n, 1),
                            this
                        },
                        divide: function(e) {
                            function n(e, n, i, t) {
                            ...
                            return this._value = r.reduce([this._value, e], n),
                            this
                        },
                    ...
                    e.register("format", "bps", {
                        ...
                        format: function(r, n, i) {
                            ...
                            e._.includes(t, ")") ? ((t = t.split("")).splice(-1, 0, l + "BPS"),
                            t = t.join("")) : t = t + l + "BPS",
                            t
                        },
                        unformat: function(r) {
                    ...
                    e.register("format", "bytes", {
                        ...
                        format: function(r, t, l) {
                            var o, a, s, u = e._.includes(t, "ib") ? i : n, c = e._.includes(t, " b") || e._.includes(t, " ib") ? " " : "";
                            for (t = t.replace(/\s?i?b/, ""),
                            o = 0; o <= u.suffixes.length; o++)
                                if (a = Math.pow(u.base, o),
                    ...
                    e.register("format", "exponential", {
                        ...
                        unformat: function(r) {
                            ...
                            return t = e._.includes(r, "e-") ? t *= -1 : t,
                            e._.reduce([i, Math.pow(10, t)], l, 1)
                        }
                    }),
                    ...
                    e.register("format", "percentage", {
                        ...
                        format: function(r, n, i) {
                            ...
                            n = n.replace(/\s?\%/, ""),
                            t = e._.numberToFormat(r, n, i),
                            e._.includes(t, ")") ? ((t = t.split("")).splice(-1, 0, l + "%"),
                            t = t.join("")) : t = t + l + "%",
                            t
                        },
                        unformat: function(r) {
                    ...
                    e.register("format", "time", {
                        ...
                        unformat: function(e) {
                            var r = e.split(":")
                              , n = 0;
                            return 3 === r.length ? (n += 60 * Number(r[0]) * 60,
                            n += 60 * Number(r[1]),
                            n += Number(r[2])) : 2 === r.length && (n += 60 * Number(r[0]),
                            n += Number(r[1])),
                            Number(n)
                        }
                    }),
        ...
        n.d = function(e, r) {
            for (var i in r)
                n.o(r, i) && !n.o(e, i) && Object.defineProperty(e, i, {
                    enumerable: !0,
                    get: r[i]
                })
        }
