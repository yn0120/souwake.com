!function(t, e) {
    ...
    return function() {
        ...
        const O = t => t <= .0031308 ? 12.92 * t : 1.055 * Math.pow(t, 1 / 2.4) - .055
        ...
        class R {
            constructor(t) {
                ...
                let i;
                var s, n, o;
                "object" === e ? i = L(t) : "string" === e && (o = (s = t).length,
                "#" === s[0] && (4 === o || 5 === o ? n = {
                    r: 255 & 17 * h[s[1]],
                    g: 255 & 17 * h[s[2]],
                    b: 255 & 17 * h[s[3]],
            ...
            mix(t, e) {
                if (t) {
                    ...
                    n = 1 - h,
                    i.r = 255 & h * i.r + n * s.r + .5,
                    i.g = 255 & h * i.g + n * s.g + .5,
                    i.b = 255 & h * i.b + n * s.b + .5,
                    i.a = o * i.a + (1 - o) * s.a,
                    this.rgb = i
                }
                return this
        ...
        function Bt(t, e, i) {
            ...
            if (t._sorted) {
                ...
                o = u ? Dt(Math.max(At(r, a.axis, c, !0).hi + 1, i ? 0 : At(e, h, a.getPixelForValue(c), !0).hi + 1), n, s) - n : s - n
            }
            return {
                start: n,
                count: o
        ...
        const Nt = t => 0 === t || 1 === t
          ...
          , $t = {
            ...
            easeInElastic: t => Nt(t) ? t : Ht(t, .075, .3),
            easeOutElastic: t => Nt(t) ? t : jt(t, .075, .3),
            easeInOutElastic(t) {
                const e = .1125;
                return Nt(t) ? t : t < .5 ? .5 * Ht(2 * t, e, .45) : .5 + .5 * jt(2 * t - 1, e, .45)
            },
            easeInBack(t) {
                const e = 1.70158;
                return t * t * ((e + 1) * t - e)
            ...
            easeInOutBounce: t => t < .5 ? .5 * $t.easeInBounce(2 * t) : .5 * $t.easeOutBounce(2 * t - 1) + .5
        };
        function Yt(t) {
        ...
        function Xt(t) {
            return Yt(t) ? t : new R(t).saturate(.5).darken(.1).hexString()
        }
        ...
        const Jt = {
            ...
            numeric(t, e, i) {
                ...
                return Object.assign(h, this.options.ticks.format),
                Zt(t, s, h)
            },
            logarithmic(t, e, i) {
                if (0 === t)
        ...
        function Te(t, e=[""], i, s, n= () => t[0]) {
            ...
            return new Proxy(a,{
                ...
                get(i, s) {
                    return ze(i, s, ( () => function(t, e, i, s) {
                        let n;
                        for (const o of e)
                            if (n = He(Re(o, t), i),
                            void 0 !== n)
        ...
        function Le(t, e, i, s) {
            ...
            return new Proxy(n,{
                ...
                get(t, e, i) {
                    return ze(t, e, ( () => function(t, e, i) {
                        const {_proxy: s, _context: n, _subProxy: o, _descriptors: a} = t;
                        let r = s[e];
                        st(r) && a.isScriptable(e) && (r = function(t, e, i, s) {
                            ...
                            let h = e(o, a || s);
                            r.delete(t),
                            Ie(t, h) && (h = We(n._scopes, n, t, h));
                            return h
                        }(e, r, t, i));
                        V(r) && r.length && (r = function(t, e, i, s) {
        ...
        function We(t, e, i, s) {
            ...
            return null !== h && ((void 0 === o || o === i || (h = Ne(r, a, o, h, s),
            null !== h)) && Te(Array.from(r), [""], n, o, ( () => function(t, e, i) {
        ...
        function Ke(t, e="x") {
            ...
            !function(t, e, i) {
                const s = t.length;
                let n, o, a, r, h, l = Ue(t, 0);
                for (let c = 0; c < s - 1; ++c)
                    h = l,
                    l = Ue(t, c + 1),
                    h && l && (pt(e[c], 0, Ye) ? i[c] = i[c + 1] = 0 : (n = i[c] / e[c],
                    o = i[c + 1] / e[c],
        ...
        function Ze(t, e, i, s, n) {
            ...
            e.capBezierPoints && function(t, e) {
                ...
                s = t.length; i < s; ++i)
                    ...
                    r = i < s - 1 && ue(t[i + 1], e),
                    o && (n = t[i],
                    a && (n.cp1x = Ge(n.cp1x, e.left, e.right),
                    n.cp1y = Ge(n.cp1y, e.top, e.bottom)),
                    r && (n.cp2x = Ge(n.cp2x, e.left, e.right),
        ...
        function ai(t, e, i, s) {
            ...
            l && !c && (c = oi(l / 2));
            return (void 0 !== e || void 0 !== i) && s && h.height && c > h.height && (c = h.height,
            l = oi(Math.floor(c * s))),
            {
                width: l,
                height: c
        ...
        const hi = function() {
            ...
            try {
                ...
                Je() && (window.addEventListener("test", null, e),
        ...
        function Mi(t, e) {
            ...
            const i = []
              , s = function(t, e) {
                return Yt(e) ? (i.includes(e) || i.push(e),
                i.indexOf(e)) : e
            };
        ...
        class Oi {
            ...
            _createAnimations(t, e) {
                ...
                for (r = o.length - 1; r >= 0; --r) {
                    ...
                    d && d.duration ? (n[h] = c = new Di(d,t,h,l),
                    s.push(c)) : t[h] = l
                }
                return s
            }
            update(t, e) {
                ...
                return i.length ? (ki.add(this._chart, i),
                !0) : void 0
            }
        }
        function Ci(t, e) {
        ...
        class Wi {
            ...
            parse(t, e) {
                ...
                if (!1 === this._parsing)
                    ...
                    l = V(s[t]) ? this.parseArrayData(i, s, t, e) : B(s[t]) ? this.parseObjectData(i, s, t, e) : this.parsePrimitiveData(i, s, t, e);
            ...
            getMinMax(t, e) {
                ...
                for (d = 0; d < o && (f() || (this.updateRangeFromParsed(h, t, u, r),
                !n)); ++d)
                    ;
                if (n)
                    for (d = o - 1; d >= 0; --d)
            ...
            _resolveAnimations(t, e, i) {
                ...
                return r && r._cacheable && (n[o] = Object.freeze(h)),
                h
            }
            getSharedOptions(t) {
                if (t.$shared)
        ...
        function Ni(t) {
            ...
            const h = () => {
                32767 !== o && -32768 !== o && (it(a) && (r = Math.min(r, Math.abs(o - a) || r)),
                a = o)
            }
            ;
            for (s = 0,
        ...
        function Yi(t, e, i, s) {
            ...
            (i._top || 0) === s ? n = l : (i._bottom || 0) === s ? n = c : (o[Ui(c, a, r, h)] = !0,
            n = l)),
            o[Ui(n, a, r, h)] = !0,
            t.borderSkipped = o
        }
        function Ui(t, e, i, s) {
            var n, o, a;
            return s ? (a = i,
            t = Xi(t = (n = t) === (o = e) ? a : n === a ? o : n, i, e)) : t = Xi(t, e, i),
            t
        }
        function Xi(t, e, i) {
        ...
        class Ki extends Wi {
            ...
            update(t) {
                const e = this.chart
                  ...
                  , r = Math.min((h = this.options.cutout,
                l = a,
                "string" == typeof h && h.endsWith("%") ? parseFloat(h) / 100 : +h / l), 1);
                var h, l;
        ...
        var Zi = Object.freeze({
            ...
            BarController: class extends Wi {
                ...
                _getStacks(t, e) {
                    ...
                    ;
                    for (const i of s)
                        if ((void 0 === e || !h(i)) && ((!1 === n || -1 === o.indexOf(i.stack) || void 0 === n && void 0 === i.stack) && o.push(i.stack),
                        i.index === t))
                            break;
                    ...
                    if (e.grouped) {
                        const i = n ? this._getStackCount(t) : e.stackCount
                          , h = "flex" === s.barThickness ? function(t, e, i, s) {
                            ...
                            let o, a;
                            return F(n) ? (o = e.min * i.categoryPercentage,
            ...
            BubbleController: class extends Wi {
                ...
                updateElements(t, e, i, s) {
                    ...
                    for (let d = e; d < e + i; d++) {
                        ...
                        h && (u.options = r || this.resolveDataElementOptions(d, e.active ? "active" : s),
        ...
        function ss(t, e, i, s, n) {
            ...
            if (!n && !t.isPointInArea(e))
                return o;
            return is(t, i, e, (function(i, a, r) {
        ...
        function ns(t, e, i, s, n, o) {
            ...
            return is(t, i, e, (function(i, l, c) {
        ...
        function os(t, e, i, s, n, o) {
            return o || t.isPointInArea(e) ? "r" !== i || s ? ns(t, e, i, s, n, o) : function(t, e, i, s) {
                let n = [];
                return is(t, i, e, (function(t, i, o) {
        ...
        function us(t, e) {
            ...
            a = t.length; o < a; ++o) {
                ...
                r.horizontal ? (r.width = l ? l * s : a && e.availableWidth,
                ...
                const n = De(t.options.layout.padding)
                  ...
                  , r = function(t) {
                    const e = function(t) {
                      ...
                      , i = ds(e.filter((t => t.box.fullSize)), !0)
                      , s = ds(ls(e, "left"), !0)
                      , n = ds(ls(e, "right"))
                      , o = ds(ls(e, "top"), !0)
                      , a = ds(ls(e, "bottom"))
        ...
        function Bs(t, e) {
            ...
            if (a > 0) {
                ...
                for (Ws(e, l, c, F(s) ? 0 : r - s, r),
                t = 0,
                i = a - 1; t < i; t++)
                    Ws(e, l, c, o[t], o[t + 1]);
                return Ws(e, l, c, h, F(s) ? e.length : h + s),
                l
            }
            return Ws(e, l, c),
            l
        ...
        function $s(t, e, i) {
            ...
            if (!(i && (h = 1 === s ? Math.max(l - o, a - l) : 0 === e ? (t.getPixelForTick(1) - l) / 2 : (l - t.getPixelForTick(n - 1)) / 2,
            l += n < e ? h : -h,
            l < o - r || l > a + r)))
                return l
        }
        ...
        class qs extends Vs {
            ...
            getUserBounds() {
                ...
                return t = N(t, Number.POSITIVE_INFINITY),
            ...
            update(t, e, i) {
                ...
                o.display && (o.autoSkip || "auto" === o.source) && (this.ticks = Bs(this, this.ticks),
                this._labelSizes = null,
                this.afterAutoSkip()),
            ...
            calculateLabelRotation() {
                ...
                r = Math.sqrt(c * c + d * d),
                h = yt(Math.min(Math.asin(Dt((l.highest.height + 6) / o, -1, 1)), Math.asin(Dt(a / r, -1, 1)) - Math.asin(Dt(d / r, -1, 1)))),
            ...
            fit() {
                ...
                if (o) {
                    ...
                    t.height = Ys(n) + o) : (t.height = this.maxHeight,
                    t.width = Ys(n) + o),
            ...
            _computeLabelSizes(t, e, i) {
                ...
                let h, l, c, d, u, f, g, p, m, b, x, _ = 0, y = 0;
                for (h = 0; h < e; h += r) {
                    if (d = t[h].label,
                    ...
                    F(d) || V(d)) {
                        if (V(d))
                            ...
                            c = d.length; l < c; ++l)
                                x = d[l],
                                F(x) || V(x) || (m = ae(s, g.data, g.gc, m, x),
                                b += p)
                    } else
                        m = ae(s, g.data, g.gc, m, d),
                        b = p;
                    o.push(m),
                    a.push(b),
                    _ = Math.max(m, _),
            ...
            _computeLabelItems(t) {
                ...
                b = a.length; m < b; ++m) {
                    ...
                    D = "top" === s ? "near" === h || 0 !== g ? -P * S + S / 2 : "center" === h ? -C.highest.height / 2 - e * S + S : -C.highest.height + S / 2 : "near" === h || 0 !== g ? S / 2 : "center" === h ? C.highest.height / 2 - e * S : C.highest.height - P * S,
                    c && (D *= -1),
            ...
            _getYAxisLabelAlignment(t) {
                ...
                let r, h;
                return "left" === e ? s ? (h = this.right + n,
                "near" === i ? r = "left" : "center" === i ? (r = "center",
                h += a / 2) : (r = "right",
                h += a)) : (h = this.right - o,
                "near" === i ? r = "right" : "center" === i ? (r = "center",
                h -= a / 2) : (r = "left",
                h = this.left)) : "right" === e ? s ? (h = this.left + n,
                "near" === i ? r = "right" : "center" === i ? (r = "center",
                h -= a / 2) : (r = "left",
                h -= a)) : (h = this.left + o,
                "near" === i ? r = "left" : "center" === i ? (r = "center",
                h += a / 2) : (r = "right",
                h = this.right)) : r = "right",
                {
                    textAlign: r,
                    x: h
                }
            ...
            drawBorder() {
                ...
                const a = s.setContext(this.getContext(0)).lineWidth
                  , r = this._borderValue;
                let h, l, c, d;
                this.isHorizontal() ? (h = he(t, this.left, o) - o / 2,
                l = he(t, this.right, a) + a / 2,
                c = d = r) : (c = he(t, this.top, o) - o / 2,
            ...
            drawTitle() {
                ...
                "bottom" === e || "center" === e || B(e) ? (r += o.bottom,
                V(i.text) && (r += n.lineHeight * (i.text.length - 1))) : r += o.top;
        ...
        class Js {
            ...
            invalidate() {
                F(this._cache) || (this._oldCache = this._cache,
                this._cache = void 0)
            }
            _descriptors(t) {
                if (this._cache)
        ...
        function nn(t, ...e) {
            if (sn(t))
                return t;
            for (const s of e) {
                const e = s.axis || ("top" === (i = s.position) || "bottom" === i ? "x" : "left" === i || "right" === i ? "y" : void 0) || t.length > 1 && sn(t[0].toLowerCase());
                if (e)
                    return e
            }
            var i;
        ...
        function an(t, e) {
            ...
            return Object.keys(s).forEach((e => {
                ...
                if (a._proxy)
                    return;
                const r = nn(e, a, function(t, e) {
                    if (e.data && e.data.datasets) {
                        const i = e.data.datasets.filter((e => e.xAxisID === t || e.yAxisID === t));
                        if (i.length)
                            return on(t, "x", i[0]) || on(t, "y", i[0])
                    }
                    return {}
                }(e, t), oe.scales[a.type])
                  , h = function(t, e) {
        ...
        function vn(t) {
            return Je() && "string" == typeof t ? t = document.getElementById(t) : t && t.length && (t = t[0]),
        ...
        class Pn {
            ...
            constructor(t, e) {
                ...
                this._dataChanges = [],
                Mn[this.id] = this,
                a && r && (ki.listen(this, "complete", _n),
            ...
            clear() {
                return le(this.canvas, this.ctx),
                this
            }
            stop() {
                return ki.stop(this),
            ...
            _resize(t, e) {
                ...
                this._aspectRatio = this.aspectRatio,
                ri(this, a, !0) && (this.notifyPlugins("resize", {
                    size: o
                }),
            ...
            _checkEventBindings() {
                const t = this.options
                  ...
                  , i = new Set(t.events);
                nt(e, i) && !!this._responsiveListeners === t.responsive || (this.unbindEvents(),
                this.bindEvents())
            }
            ...
            render() {
                !1 !== this.notifyPlugins("beforeRender", {
                    cancelable: !0
                }) && (ki.has(this) ? this.attached && !ki.running(this) && ki.start(this) : (this.draw(),
                _n({
                    chart: this
                })))
            }
        ...
        function An(t, e, i, s, n, o) {
            ...
            const p = (g - Math.max(.001, g * d - i / ot) / d) / 2
              , m = h + p + f
              , b = n - p - f
        ...
        function Tn(t, e, i, s, n) {
            ...
            t.lineDashOffset = u,
            f ? (t.lineWidth = 2 * l,
            t.lineJoin = c || "round") : (t.lineWidth = l,
            t.lineJoin = c || "bevel");
            let g = e.endAngle;
            if (o) {
                An(t, e, i, s, g, n);
            ...
            f && function(t, e, i) {
                ...
                t.arc(o, a, r, s - l, i + l),
                h > n ? (l = n / h,
                t.arc(o, a, h, i + l, s - l, !0)) : t.arc(o, a, n, i + ct, s - ct),
                t.closePath(),
                t.clip()
            }(t, e, g),
            o || (An(t, e, i, s, g, n),
        ...
        function Bn(t, e, i, s) {
            Vn && !e.options.segment ? function(t, e, i, s) {
                let n = e._path;
        ...
        var qn = Object.freeze({
            ...
            ArcElement: class extends Vs {
                ...
                inRange(t, e, i) {
                    const s = this.getProps(["x", "y"], i)
                      , {angle: n, distance: o} = Mt(s, {
                        x: t,
                        y: e
                    })
                      , {startAngle: a, endAngle: r, innerRadius: h, outerRadius: l, circumference: c} = this.getProps(["startAngle", "endAngle", "innerRadius", "outerRadius", "circumference"], i)
            ...
            PointElement: class extends Vs {
                ...
                draw(t, e) {
                    const i = this.options;
                    this.skip || i.radius < .1 || !ue(this, e, this.size(i) / 2) || (t.strokeStyle = i.borderColor,
        ...
        const Kn = ["rgb(54, 162, 235)", "rgb(255, 99, 132)", "rgb(255, 159, 64)", "rgb(255, 205, 86)", "rgb(75, 192, 192)", "rgb(153, 102, 255)", "rgb(201, 203, 207)"]
        ...
        function Qn(t) {
            ...
            return (i, s) => {
                ...
                n instanceof Ki ? e = function(t, e) {
                    return t.backgroundColor = t.data.map(( () => Zn(e++))),
                    e
                }(i, e) : n instanceof Gi ? e = function(t, e) {
                    return t.backgroundColor = t.data.map(( () => Jn(e++))),
                    e
                }(i, e) : n && (e = function(t, e) {
                    return t.borderColor = Zn(e),
        ...
        var eo = {
            ...
            beforeLayout(t, e, i) {
                ...
                const {data: {datasets: s}, options: n} = t.config
                  , {elements: o} = n
                  , a = to(s) || (r = n) && (r.borderColor || r.backgroundColor) || o && to(o) || "rgba(0,0,0,0.1)" !== oe.borderColor || "rgba(0,0,0,0.1)" !== oe.backgroundColor;
                var r;
            ...
            beforeElementsUpdate: (t, e, i) => {
                ...
                t.data.datasets.forEach(( (e, n) => {
                    ...
                    let {start: c, count: d} = function(t, e) {
                        ...
                        return h && (n = Dt(At(e, o.axis, a).lo, 0, i - 1)),
                    ...
                    case "min-max":
                        u = function(t, e, i, s) {
                            let n, o, a, r, h, l, c, d, u, f, g = 0, p = 0;
                            const m = []
                              , b = e + i - 1
                              , x = t[e].x
                              , _ = t[b].x - x;
        ...
        function uo(t, e, i) {
            ...
            let n = parseFloat(s);
            return W(n) && Math.floor(n) === n ? function(t, e, i, s) {
                "-" !== t && "+" !== t || (i = e + i);
                if (i === e || i < 0 || i >= s)
                    return !1;
                return i
            ...
            const n = function(t) {
                ...
                if (e.getPointPositionForValue)
                    return function(t) {
                        const {scale: e, fill: i} = t
                          ...
                          , a = function(t, e, i) {
                            let s;
                            return s = "start" === t ? i : "end" === t ? e.options.reverse ? e.min : e.max : B(t) ? t.value : e.getBaseValue(),
                            s
                        }(i, e, o)
                          , r = [];
                        if (s.grid.circular) {
                ...
                return function(t) {
                    const {scale: e={}, fill: i} = t
                      , s = function(t, e) {
                        let i = null;
                        return "start" === t ? i = e.bottom : "end" === t ? i = e.top : B(t) ? i = e.getPixelForValue(t.value) : e.getBasePixel && (i = e.getBasePixel()),
                        i
                    }(i, e);
                    if (W(s)) {
        ...
        function bo(t, e, i) {
            ...
            s && n.points.length && (fe(t, i),
            function(t, e) {
                const {line: i, target: s, above: n, below: o, area: a, scale: r} = e
                  , h = i._loop ? "angle" : e.axis;
                t.save(),
                "x" === h && o !== n && (xo(t, s, a.top),
                _o(t, {
                    line: i,
                    target: s,
                    color: n,
        ...
        class ko extends Vs {
            ...
            fit() {
                ...
                l = this._fitRows(o, n, a, r) + 10) : (l = this.maxHeight,
            ...
            _draw() {
                ...
                this.legendItems.forEach(( (_, y) => {
                    ...
                    m ? y > 0 && k + w + l > this.right && (S = u.y += x,
                    u.line++,
                    k = u.x = Vt(n, this.left + l, this.right - i[u.line])) : y > 0 && S + x > this.bottom && (k = u.x = k + e[u.line].width + l,
                    u.line++,
                    ...
                    if (function(t, e, i) {
                        ...
                        o.usePointStyle) {
                            ...
                            const o = e + Math.max((c - g) / 2, 0)
                              ...
                              , h = Pe(i.borderRadius);
                            s.beginPath(),
                            Object.values(h).some((t => 0 !== t)) ? ye(s, {
                                x: a,
                                y: o,
                                w: f,
                                h: g,
        ...
        class Do extends Vs {
            ...
            _drawArgs(t) {
                const {top: e, left: i, bottom: s, right: n, options: o} = this
                  , a = o.align;
                let r, h, l, c = 0;
                return this.isHorizontal() ? (h = Vt(a, i, n),
                l = e + t,
                r = n - i) : ("left" === o.position ? (h = i + t,
                l = Vt(a, s, e),
                c = -.5 * ot) : (h = n - t,
                l = Vt(a, e, s),
                c = .5 * ot),
        ...
        function Lo(t, e) {
            return e && (V(e) ? Array.prototype.push.apply(t, e) : t.push(e)),
            t
        }
        function Eo(t) {
        ...
        function zo(t, e, i, s) {
            const {x: n, width: o} = i
              , {width: a, chartArea: {left: r, right: h}} = t;
            let l = "center";
        ...
        class $o extends Vs {
            ...
            getCaretPosition(t, e, i) {
                ...
                x = _ - o,
                y = _ + o),
                b = p) : (m = "left" === s ? d + Math.max(r, l) + o : "right" === s ? d + f - Math.max(h, c) - o : this.caretX,
                "top" === n ? (x = u,
                _ = x - o,
                p = m - o,
                b = m + o) : (x = u + g,
            ...
            drawTitle(t, e, i) {
                ...
                if (n) {
                    ...
                    for (t.x = Bo(this, i.titleAlign, i),
            ...
            drawFooter(t, e, i) {
                ...
                if (n) {
                    ...
                    for (t.x = Bo(this, i.footerAlign, i),
            ...
            _updateAnimationTarget(t) {
                ...
                if (s || n) {
                    ...
                    const o = this._size = Io(this, t)
                      ...
                      , r = Fo(e, t, a)
                      , h = Vo(t, a, r, e);
                    s._to === h.x && n._to === h.y || (this.xAlign = r.xAlign,
                    this.yAlign = r.yAlign,
                    this.width = o.width,
                    this.height = o.height,
                    this.caretX = i.x,
        ...
        function Ko(t, e) {
            ...
            m && b && n && function(t, e) {
                ...
                return i - e <= t && i + e >= t
            }((a - o) / n, k / 1e3) ? (w = Math.round(Math.min((a - o) / k, l)),
            k = (a - o) / w,
            v = o,
            M = a) : x ? (v = m ? o : v,
            M = b ? a : M,
            ...
            v < o && P++,
            pt(Math.round((v + P * k) * y) / y, o, Go(o, _, t)) && P++) : v < o && P++); P < w; ++P) {
            ...
            return b && d && M !== a ? i.length && pt(i[i.length - 1].value, a, Go(a, _, t)) ? i[i.length - 1].value = a : i.push({
                value: a
            }) : b && M !== a || i.push({
                value: M
            }),
        ...
        class Zo extends qs {
            ...
            getTickLimit() {
                ...
                e > 1e3 && (e = 1e3)) : (e = this.computeTickLimit(),
                i = i || 11),
                i && (e = Math.min(i, e)),
                e
            }
            ...
            buildTicks() {
                ...
                return "ticks" === t.bounds && xt(s, this, "value"),
                t.reverse ? (s.reverse(),
                this.start = this.max,
        ...
        class na extends qs {
            ...
            determineDataLimits() {
                ...
                this._zero && this.min !== this._suggestedMin && !W(this._userMin) && (this.min = t === ta(this.min, 0) ? ta(this.min, -1) : ta(this.min, 0)),
                this.handleTickRangeOptions()
            }
            handleTickRangeOptions() {
            ...
            buildTicks() {
                ...
                return "ticks" === t.bounds && xt(e, this, "value"),
                t.reverse ? (e.reverse(),
                this.start = this.max,
                this.end = this.min) : (this.start = this.min,
                this.end = this.max),
        ...
        function ha(t, e, i, s, n) {
            ...
            n.start < e.t ? (h = (e.t - n.start) / a,
            t.t = Math.min(t.t, e.t - h)) : n.end > e.b && (h = (n.end - e.b) / a,
        ...
        function ba(t, e) {
            ...
            null === a ? null : (n && (a = "week" !== n || !bt(o) && !0 !== o ? i.startOf(a, n) : i.startOf(a, "isoWeek", o)),
            +a)
        }
        function xa(t, e, i, s) {
            const n = pa.length;
        ...
        class va extends qs {
            ...
            buildTicks() {
                ...
                return this._unit = e.unit || (i.autoSkip ? xa(e.minUnit, this.min, this.max, this._getLabelCapacity(n)) : function(t, e, i, s, n) {
            ...
            _generate() {
                ...
                d++)
                    _a(l, c, f);
                return c !== i && "ticks" !== s.bounds && 1 !== d || _a(l, c, f),
                Object.keys(l).sort(ma).map((t => +t))
            }
            getLabelForValue(t) {
        ...
        function Ma(t, e, i) {
            ...
            i ? (e >= t[r].pos && e <= t[h].pos && ({lo: r, hi: h} = At(t, "pos", e)),
            ({pos: s, time: o} = t[r]),
            ({pos: n, time: a} = t[h])) : (e >= t[r].time && e <= t[h].time && ({lo: r, hi: h} = At(t, "time", e)),
            ({time: s, pos: o} = t[r]),
            ({time: n, pos: a} = t[h]));
            const l = n - s;
        ...
        var wa = Object.freeze({
            ...
            CategoryScale: class extends qs {
                ...
                parse(t, e) {
                    ...
                    return ( (t, e) => null === t ? null : Dt(Math.round(t), 0, e))(e = isFinite(e) && i[e] === t ? e : Xo(i, t, H(e, t), this._addedLabels), i.length - 1)
                }
                determineDataLimits() {
                    const {minDefined: t, maxDefined: e} = this.getUserBounds();
