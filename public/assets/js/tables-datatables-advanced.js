document.addEventListener("DOMContentLoaded", function(e) {
    let s = document.querySelector(".start_date")
      ...
      , d = (o && o.flatpickr({
        ...
        onClose: function(e, t, a) {
            var n;
            new Date;
            void 0 !== e[0] && (n = new Date(e[0]).toLocaleDateString("en-US", {
                month: "2-digit",
                day: "2-digit",
                year: "numeric"
            }),
            s.value = n),
            void 0 !== e[1] && (n = new Date(e[1]).toLocaleDateString("en-US", {
                month: "2-digit",
                day: "2-digit",
                year: "numeric"
            }),
    ...
    void 0 !== $.fn && void 0 !== $.fn.dataTableExt && ($.fn.dataTableExt.afnFiltering.length = 0),
    function(e) {
        e = new Date(e);
        ...
        let s = a.querySelectorAll("tr:nth-child(2) th")
          , l = (s.forEach( (e, t) => {
            ...
            n.addEventListener("keyup", function() {
                l.column(t).search() !== this.value && l.column(t).search(this.value).draw()
            }),
    ...
    document.querySelectorAll("input.dt-input").forEach(e => {
        e.addEventListener("keyup", function() {
            var e, t, a = this.getAttribute("data-column"), n = this.value;
            (5 == a ? (e = s.value,
            t = l.value,
            "" !== e && "" !== t && ($.fn.dataTable.ext.search.length = 0,
            ( (l, o, r) => {
                void 0 !== $.fn && void 0 !== $.fn.dataTableExt && $.fn.dataTableExt.afnFiltering.push(function(e, t, a) {
                    var t = d(t[l])
                      , n = d(o)
                      , s = d(r);
                    return n <= t && t <= s || n <= t && "" === s && "" !== n || t <= s && "" === n && "" !== s
                })
            }
            )(a, e, t)),
            r) : r.column(a).search(n, !1, !0)).draw()
        })
    }
    );
    ...
    (c = t ? new DataTable(t,{
        ...
        var e = e.target.closest("tr")
          , e = c.row(e);
        e.child.isShown() ? e.child.hide() : e.child("<dl><dt>Full name:</dt><dd>" + (e = e.data()).full_name + "</dd><dt>Post:</dt><dd>" + e.post + "</dd><dt>Salary:</dt><dd>" + e.salary + "</dd><dt>Experience:</dt><dd>" + e.experience + "</dd></dl>").show()
    }),
    setTimeout( () => {
        [{
