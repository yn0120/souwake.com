  ...
  `
    ...
    `
        ...
        t.on("dropdown:select", function(a) {
            a.detail.elm.classList.contains(t.settings.classNames.dropdownItem + "__addAll") && t.dropdown.selectAll()
    ...
    if (e = document.querySelector("#TagifyEmailList")) {
        t = Array.from({
            ...
            length: Math.floor(10 * Math.random() + 3)
        }, () => String.fromCharCode(26 * Math.random() + 97)).join("") + "@gmail.com");
        let a = new Tagify(e,{
