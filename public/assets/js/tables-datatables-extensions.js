document.addEventListener("DOMContentLoaded", function(e) {
    ...
    window.Helpers.isNavbarFixed() ? (t = document.getElementById("layout-navbar").offsetHeight,
    new DataTable.FixedHeader(s).headerOffset(t)) : new DataTable.FixedHeader(s),
    document.addEventListener("click", function(e) {
        e.target.classList.contains("delete-record") && (s.row(e.target.closest("tr")).remove().draw(),
        e = document.querySelector(".dtr-bs-modal")) && e.classList.contains("show") && bootstrap.Modal.getInstance(e)?.hide()
    })),
    document.querySelector(".dt-fixedcolumns")), l;
    r && ((t = document.createElement("h5")).classList.add("card-title", "mb-0", "text-md-start", "text-center", "pb-md-0", "pb-6"),
