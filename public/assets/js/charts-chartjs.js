document.addEventListener("DOMContentLoaded", function(o) {
    ...
    document.getElementById("radarChart"))
      , g = (g && ((x = g.getContext("2d").createLinearGradient(0, 0, 0, 150)).addColorStop(0, "rgba(85, 85, 255, 0.9)"),
    x.addColorStop(1, "rgba(151, 135, 255, 0.8)"),
    (u = g.getContext("2d").createLinearGradient(0, 0, 0, 150)).addColorStop(0, "rgba(255, 85, 184, 0.9)"),
