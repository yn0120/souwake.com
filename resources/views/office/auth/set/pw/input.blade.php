...
@section('meta')
    <title>パスワード設定 | {{ config('app.name') }}</title>
@endsection
            ...
            <div class="authentication-inner">
                ...
                <div class="card px-sm-6 px-0">
                    <div class="card-body">
                        ...
                        <!-- /Logo -->
                        <p class="mb-6">
                            新しいパスワードを入力し、「設定する」をクリックしてください。
                        </p>
                        {{-- エラー/サクセス メッセージ --}}
                        @include ('office/parts/item/alert')
                        <form method="POST" action="{{ route('officeSetPwExecute', [], false) }}" class="mb-6 fv-plugins-bootstrap5 fv-plugins-framework" id="formAuthentication" novalidate="novalidate">
