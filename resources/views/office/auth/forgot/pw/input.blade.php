            ...
            <div class="authentication-inner">
                ...
                <div class="card px-sm-6 px-0">
                    <div class="card-body">
                        ...
                        {{-- エラー/サクセス メッセージ --}}
                        @include ('office/parts/item/alert')
                        <form method="POST" action="{{ route('officeForgotPwExecute', [], false) }}" class="mb-6 fv-plugins-bootstrap5 fv-plugins-framework" id="formAuthentication" novalidate="novalidate">
