...
@section('meta')
    <title>管理者初期IDPW編集 | {{ config('app.name') }}</title>
@endsection
            ...
            <div class="authentication-inner">
                ...
                <div class="card px-sm-6 px-0">
                    <div class="card-body">
                        ...
                        <!-- /Logo -->
                        <p class="mb-6">
                            管理者情報を入力し、「設定する」をクリックしてください。
                        </p>
                        {{-- エラー/サクセス メッセージ --}}
                        @include ('office/parts/item/alert')
                        <form method="POST" action="{{ route('officeInitExecute', [], false) }}" class="mb-6 fv-plugins-bootstrap5 fv-plugins-framework" id="formAuthentication" novalidate="novalidate">
                            <div class="mb-6 form-control-validation fv-plugins-icon-container">
                                <label for="name" class="form-label">
                                    氏名
                                </label>
                                <input type="text" name="name" value="{{ old('name') }}" class="form-control @error('name') is-invalid @enderror" id="name" placeholder="そうすけ" autofocus="">
                            ...
                            <div class="mb-6 form-control-validation fv-plugins-icon-container">
                                ...
                                <input type="text" name="email" value="{{ old('email') }}" class="form-control @error('email') is-invalid @enderror" id="email" placeholder="email@souwake.com">
                                <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback">
                                    @error('email')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="my-7 form-control-validation fv-plugins-icon-container"></div>
