            ...
            <div class="authentication-inner">
                ...
                <div class="card px-sm-6 px-0">
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('officeLoginExecute', [], false) }}" id="formAuthentication" class="mb-6 fv-plugins-bootstrap5 fv-plugins-framework" novalidate="novalidate" enctype="multipart/form-data">
                            <div class="mb-6 form-control-validation fv-plugins-icon-container">
                                <label for="email" class="form-label">
                                    メールアドレス
                                </label>
                                <input type="email" name="email" value="{{ old('email') }}" class="form-control @error('email') is-invalid @enderror" id="email" placeholder="email@souwake.com" autofocus="">
                            ...
                            <div class="mb-7">
                                <div class="d-flex justify-content-between">
                                    <a href="{{ route('officeForgotPwInput', [], false) }}">
                                        <span>
                                            パスワードを忘れたら
                                        </span>
                                    </a>
