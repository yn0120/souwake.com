            ...
            <div class="authentication-inner">
                ...
                <div class="card px-sm-6 px-0">
                    <div class="card-body">
                        ...
                        {{-- エラー/サクセス メッセージ --}}
                        @include ('office/parts/item/alert')
                        <form method="POST" action="{{ route('officeOnetimeExecute', [], false) }}" class="mb-6 fv-plugins-bootstrap5 fv-plugins-framework" id="formAuthentication" novalidate="novalidate">
                            <div class="mb-6 form-control-validation fv-plugins-icon-container">
                                <label for="onetime_key" class="form-label">
                                    ワンタイムキー
                                </label>
                                <input type="text" name="onetime_key" value="{{ old('onetime_key') }}" class="form-control @error('onetime_key') is-invalid @enderror" id="onetime_key" placeholder="1234567890" autofocus="" autocomplete="off">
