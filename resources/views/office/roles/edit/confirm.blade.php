...
@section('meta')
    <title>権限確認 | {{ config('app.name') }}</title>
@endsection
                            ...
                            <div class="card p-5">
                                <div class="row">
                                    <div class="col-12 pt-2">
                                        <h5 class="card-title">権限編集確認</h5>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-12">
                                        <form method="POST" action="{{ route('officeRoleEditExecute', ['id' => $assign['record']->id], false) }}" class="form" enctype="multipart/form-data">
                                            @csrf
