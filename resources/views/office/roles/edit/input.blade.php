...
@section('meta')
    <title>権限編集 | {{ config('app.name') }}</title>
@endsection
                            ...
                            <div class="card p-5">
                                <div class="row">
                                    <div class="col-12 pt-2">
                                        <h5 class="card-title">権限編集</h5>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-12">
                                        <form method="POST" action="{{ App\Libraries\Utils::urlToPath(route('officeRoleEditConfirm', ['id' => $assign['record']->id])) }}" class="form" enctype="multipart/form-data">
                                            @csrf
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-8 form-text pt-0 pb-2 py-md-2 fs-6 text-break">
                                                    <textarea name="note" id="note" class="form-control autoHeight">{{ old('note', $assign['record']->note) }}</textarea>
                                                </div>
                                                @error ('note')
                                                    <div class="col-md-3"></div>
                                                    <div class="col-md-8">
