...
@section('meta')
    <title>権限登録確認 | {{ config('app.name') }}</title>
@endsection
                            ...
                            <div class="card p-5">
                                <div class="row">
                                    <div class="col-12 pt-2">
                                        <h5 class="card-title">権限登録確認</h5>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-12">
                                        <form method="POST" action="{{ route('officeRoleCreateExecute', [], false) }}" class="form" enctype="multipart/form-data">
                                            @csrf
                                            <div class="row">
