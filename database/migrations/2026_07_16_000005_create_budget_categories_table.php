...
return new class extends Migration
{
    ...
    public function up(): void
    {
        DB::statement(<<<'SQL'
            CREATE TABLE IF NOT EXISTS budget_categories (
                ...
                `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '科目名',
            ...
            ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='家計簿の科目マスター（管理者ごと）'
        SQL);
    }
    ...
    {
        DB::statement('DROP TABLE IF EXISTS budget_categories');
    }
};
